...
type ContactCompanyService interface {
...
type contactCompanyService struct {
	driver *neo4j.Driver
}

func NewContactCompanyService(driver *neo4j.Driver) ContactCompanyService {
...
func setContactCompanyRelationshipInTx(ctx context.Context, contactId string, input entity.ContactCompanyEntity, tx neo4j.Transaction) error {
	_, err := tx.Run(`
