...
import (
	...
	"github.com/customeros/customeros/packages/server/eventstream/api/handlers"
...
func ConvertToProtoWebTrackerEvent(event *handlers.WebTrackerEvent) *pb.WebTrackerEvent {
	if event == nil {
		return nil
	}
...
func ConvertFromProtoWebTrackerEvent(pbEvent *pb.WebTrackerEvent) *handlers.WebTrackerEvent {
	if pbEvent == nil {
		return nil
	}
	...
	return &handlers.WebTrackerEvent{
		ID:               pbEvent.Id,
