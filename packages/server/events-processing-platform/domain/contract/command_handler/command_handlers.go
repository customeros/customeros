...
type CommandHandlers struct {
	...
	CloseEndedContract                  CloseEndedContractCommandHandler
	ResetRenewalOpportunityOnExpiration ResetRenewalOpportunityOnExpirationCommandHandler
}
...
func NewCommandHandlers(log logger.Logger, cfg *config.Config, es eventstore.AggregateStore) *CommandHandlers {
	return &CommandHandlers{
		...
		CloseEndedContract:                  NewCloseEndedContractCommandHandler(log, es, cfg.Utils),
		ResetRenewalOpportunityOnExpiration: NewResetRenewalOpportunityOnExpirationCommandHandler(log, es, cfg.Utils),
	}
}
