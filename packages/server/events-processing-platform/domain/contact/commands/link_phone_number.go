...
type LinkPhoneNumberCommandHandler interface {
	Handle(ctx context.Context, command *AddPhoneNumberCommand) error
}
...
func (c *linkPhoneNumberCommandHandler) Handle(ctx context.Context, command *AddPhoneNumberCommand) error {
