...
func NewCreateServiceLineItemCommand(serviceLineItemId, tenant, loggedInUserId, previousVersionId string, dataFields model.ServiceLineItemDataFields, source commonmodel.Source, createdAt, updatedAt *time.Time) *CreateServiceLineItemCommand {
