...
func NewUpdateBillingDetailsCommandHandler(log logger.Logger, cfg *config.Config, es eventstore.AggregateStore, repositories *repository.Repositories) UpdateBillingDetailsCommandHandler {
	return &updateBillingDetailsCommandHandler{log: log, cfg: cfg, es: es, repositories: repositories}
}
