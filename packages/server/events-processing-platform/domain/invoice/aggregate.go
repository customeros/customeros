...
func (a *InvoiceAggregate) FillInvoice(ctx context.Context, request *invoicepb.FillInvoiceRequest, invoiceNumber string) error {
	...
	fillEvent, err := NewInvoiceFillEvent(a, updatedAtNotNil, *a.Invoice,
		...
		request.Provider.LogoUrl, request.Provider.LogoRepositoryFileId, request.Provider.Name, request.Provider.Email, request.Provider.AddressLine1, request.Provider.AddressLine2, request.Provider.Zip, request.Provider.Locality, request.Provider.Country,
