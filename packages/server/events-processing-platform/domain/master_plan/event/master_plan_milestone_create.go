...
func NewMasterPlanMilestoneCreateEvent(aggregate eventstore.Aggregate, milestoneId, name string, durationHours, order int64, items []string, optional bool, sourceFields common.Source, createdAt time.Time) (eventstore.Event, error) {
