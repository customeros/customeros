...
type EventStoreConfig struct {
	...
	ConnectionPassword string `env:"EVENT_STORE_CONNECTION_PASSWORD"`

	AdminUsername      string `env:"EVENT_STORE_ADMIN_USERNAME"`
	AdminPassword      string `env:"EVENT_STORE_ADMIN_PASSWORD"`
	OperationsUsername string `env:"EVENT_STORE_OPS_USERNAME"`
	OperationsPassword string `env:"EVENT_STORE_OPS_PASSWORD"`
}
