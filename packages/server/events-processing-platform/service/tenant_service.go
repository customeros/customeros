...
func (s *tenantService) AddBillingProfile(ctx context.Context, request *tenantpb.AddBillingProfileRequest) (*tenantpb.IdResponse, error) {
	...
	return &tenantpb.IdResponse{Id: billingProfileId.(string)}, nil
}
