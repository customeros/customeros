...
func TestOpportunityService_CreateOpportunity(t *testing.T) {
	...
	require.Equal(t, model.OpportunityInternalTypeStringNBO, eventData.InternalType)
	require.Equal(t, "TypeA", eventData.ExternalType)
	require.Equal(t, model.OpportunityInternalStageStringOpen, eventData.InternalStage)
