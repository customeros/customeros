...
import (
	...
	"github.com/openline-ai/openline-customer-os/packages/server/email-tracking-api/config"
	"github.com/openline-ai/openline-customer-os/packages/server/email-tracking-api/constants"
	"github.com/openline-ai/openline-customer-os/packages/server/email-tracking-api/route"
...
func (server *server) Run(parentCtx context.Context) error {
	...
	commonServices := commonservice.InitServices(&commonConfig.GlobalConfig{}, postgresDb, &neo4jDriver, server.cfg.Neo4j.Database, nil, server.log)
