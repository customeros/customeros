module github.com/customeros/customeros/packages/server/mailsherpa-api
...
require (
	...
	github.com/customeros/customeros/packages/server/customer-os-neo4j-repository v0.0.0-20250422171625-b9f0106c7d32 // indirect
