...
type EnrichDetailsBetterContactRepository interface {
	...
	GetBy(ctx context.Context, linkedInUrl, firstName, lastName, companyName, companyDomain string, enrichPhoneNumber bool, lookBack time.Duration) ([]*postgres_entity.EnrichDetailsBetterContact, error)
...
func (r enrichDetailsBetterContactRepository) GetBy(ctx context.Context, linkedInUrl, firstName, lastName, companyName, companyDomain string, enrichPhoneNumber bool, lookBack time.Duration) ([]*postgres_entity.EnrichDetailsBetterContact, error) {
