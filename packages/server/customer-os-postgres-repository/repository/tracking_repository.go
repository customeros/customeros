...
func (r trackingRepositoryImpl) SetStateById(ctx context.Context, id string, newState entity.TrackingIdentificationState) error {
	span, _ := opentracing.StartSpanFromContext(ctx, "TrackingRepository.SetStateById")
	defer span.Finish()
