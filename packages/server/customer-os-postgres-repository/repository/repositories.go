...
func InitRepositories(postgresDB *config.PostgresDB) *Repositories {
	repositories := &Repositories{
		...
		FlowActionRepository:                        NewFlowActionExecutionRepository(postgresDB.GormDB),
		FlowEventsRepository:                        NewFlowActionRegistryRepository(postgresDB.GormDB),
		FlowEventsRepository:                        NewFlowExecutionRepository(postgresDB.GormDB),
		FlowEventsRepository:                        NewFlowListenerRegistryRepository(postgresDB.GormDB),
		FlowEventsRepository:                        NewFlowTransitionsRegistryRepository(postgresDB.GormDB),
