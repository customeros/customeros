...
type FlowAgentExecution struct {
	...
	Agent           string     `gorm:"column:agent;type:varchar(255);not null" json:"agent" binding:"required"`
...
func (FlowAgentExecution) TableName() string {
	return "flow_agent_execution"
}
