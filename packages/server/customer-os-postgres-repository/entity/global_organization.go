...
type GlobalOrganization struct {
	...
	IconUrl                     string    `gorm:"column:icon_url;type:varchar(255)" json:"iconUrl"`
	...
	YearFounded                 int       `gorm:"column:year_founded;type:int" json:"yearFounded"`
	EmployeeCount               int       `gorm:"column:employee_count;type:int" json:"employeeCount"`
}
