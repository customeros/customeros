...
type GlobalOrganization struct {
	...
	IndustrySetAt      time.Time `gorm:"column:industry_identified_at;type:timestamp" json:"industryIdentifiedAt"`
	DescriptionSetAt   time.Time `gorm:"column:description_identified_at;type:timestamp" json:"descriptionIdentifiedAt"`
	...
	SourceDescription4 string    `gorm:"column:source_description_3;type:text" json:"sourceDescription4"`
	SourceDescription5 string    `gorm:"column:source_description_3;type:text" json:"sourceDescription5"`
}
