module github.com/customeros/customeros/packages/server/events-subscribers
...
require (
	...
	github.com/customeros/customeros/packages/server/customer-os-common-module v0.0.0-20250213142435-9a4f34296882
