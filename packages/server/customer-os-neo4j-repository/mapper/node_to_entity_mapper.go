...
func MapDbNodeToInvoiceEntity(dbNode *dbtype.Node) *neo4j_entity.InvoiceEntity {
	...
	invoiceEntity := neo4j_entity.InvoiceEntity{
		...
		QuickbooksPaidPaymentId:         utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyQuickbooksPaidPaymentId)),
		...
		Provider: neo4j_entity.InvoiceProvider{
			...
			BankDetailsAvailable:     utils.GetBoolPropOrFalse(props, string(neo4j_entity.InvoicePropertyProviderBankDetailsAvailable)),
			BankAccountName:          utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountName)),
			BankAccountNumber:        utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountNumber)),
			BankAccountIBAN:          utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountIBAN)),
			BankAccountBIC:           utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountBIC)),
			BankAccountSortCode:      utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountSortCode)),
			BankAccountRoutingNumber: utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountRoutingNumber)),
			BankAccountOtherDetails:  utils.GetStringPropOrEmpty(props, string(neo4j_entity.InvoicePropertyProviderBankAccountOtherDetails)),
		},
...
func MapDbNodeToOrganizationEntity(dbNode *dbtype.Node) *neo4j_entity.OrganizationEntity {
	...
	organizationEntity := neo4j_entity.OrganizationEntity{
		...
		QualificationStatus:      commonenum.DecodeQualificationStatus(utils.GetStringPropOrEmpty(props, string(neo4j_entity.OrganizationPropertyQualificationStatus))),
		QualificationStatusOrder: utils.GetInt64PropOrZero(props, string(neo4j_entity.OrganizationPropertyQualificationStatusOrder)),
		QualifiedBy:              commonenum.DecodeQualifiedBy(utils.GetStringPropOrEmpty(props, string(neo4j_entity.OrganizationPropertyQualifiedBy))),
...
func MapDbNodeToTenantSettingsEntity(dbNode *dbtype.Node) *neo4j_entity.TenantSettingsEntity {
	...
	tenantSettingsEntity := neo4j_entity.TenantSettingsEntity{
		...
		WorkspaceLogoKey:         utils.GetStringPropOrEmpty(props, string(neo4j_entity.TenantSettingsPropertyWorkspaceLogoKey)),
...
func MapDbNodeToContactEntity(dbNode *dbtype.Node) *neo4j_entity.ContactEntity {
	...
	contact := neo4j_entity.ContactEntity{
		...
		EnrichDetails: neo4j_entity.ContactEnrichDetails{
			...
			EnrichedGlobalContactId:                     utils.GetStringPropOrEmpty(props, string(neo4j_entity.ContactPropertyEnrichedGlobalContactId)),
