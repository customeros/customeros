...
func MapDbNodeToInvoiceEntity(dbNode *dbtype.Node) *entity.InvoiceEntity {
	...
	invoiceEntity := entity.InvoiceEntity{
		...
		InvoiceInternalFields: entity.InvoiceInternalFields{
			...
			InvoiceFinalizedWebhookProcessedAt: utils.GetTimePropOrNil(props, "techInvoiceFinalizedWebhookProcessedAt"),
...
func MapDbNodeToEmailEntity(node *dbtype.Node) *entity.EmailEntity {
	...
	return &entity.EmailEntity{
		...
		Validated:      utils.GetBoolPropOrNil(props, string(entity.EmailPropertyValidated)),
		IsReachable:    utils.GetStringPropOrNil(props, string(entity.EmailPropertyIsReachable)),
		...
		AcceptsMail:    utils.GetBoolPropOrNil(props, string(entity.EmailPropertyAcceptsMail)),
		HasFullInbox:   utils.GetBoolPropOrNil(props, string(entity.EmailPropertyHasFullInbox)),
		...
		IsDisabled:     utils.GetBoolPropOrNil(props, string(entity.EmailPropertyIsDisabled)),
