...
func MapDbNodeToInvoiceEntity(dbNode *dbtype.Node) *entity.InvoiceEntity {
	...
	invoiceEntity := entity.InvoiceEntity{
		...
		CustomerName:                  utils.GetStringPropOrEmpty(props, "customerName"),
		CustomerAddress:               utils.GetStringPropOrEmpty(props, "customerAddress"),
		CustomerEmail:                 utils.GetStringPropOrEmpty(props, "customerEmail"),
		ProviderLogoUrl:               utils.GetStringPropOrEmpty(props, "providerLogoUrl"),
		ProviderName:                  utils.GetStringPropOrEmpty(props, "providerName"),
		ProviderAddress:               utils.GetStringPropOrEmpty(props, "providerAddress"),
