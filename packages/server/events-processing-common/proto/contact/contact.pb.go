...
var file_proto_contact_contact_proto_rawDesc = []byte{
	...
	0x41, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e,
	...
	0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xec, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x63,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x42, 0x17, 0x5a, 0x15, 0x2e, 0x2f, 0x3b, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x63, 0x74, 0x47, 0x72, 0x70, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x62, 0x06, 0x70,
...
var file_proto_contact_contact_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_contact_contact_proto_goTypes = []interface{}{
	...
	(*CreateContactGrpcRequest)(nil),  // 2: contactGrpcService.CreateContactGrpcRequest
	(*CreateContactGrpcResponse)(nil), // 3: contactGrpcService.CreateContactGrpcResponse
	(*ContactIdGrpcResponse)(nil),     // 4: contactGrpcService.ContactIdGrpcResponse
	(*timestamppb.Timestamp)(nil),     // 5: google.protobuf.Timestamp
}
var file_proto_contact_contact_proto_depIdxs = []int32{
	5, // 0: contactGrpcService.UpsertContactGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	5, // 1: contactGrpcService.UpsertContactGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	2, // 2: contactGrpcService.contactGrpcService.CreateContact:input_type -> contactGrpcService.CreateContactGrpcRequest
	1, // 3: contactGrpcService.contactGrpcService.UpsertContact:input_type -> contactGrpcService.UpsertContactGrpcRequest
	3, // 4: contactGrpcService.contactGrpcService.CreateContact:output_type -> contactGrpcService.CreateContactGrpcResponse
	4, // 5: contactGrpcService.contactGrpcService.UpsertContact:output_type -> contactGrpcService.ContactIdGrpcResponse
