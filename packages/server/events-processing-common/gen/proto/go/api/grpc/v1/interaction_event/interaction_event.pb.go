...
type RequestGenerateActionItensGrpcRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RequestGenerateActionItensGrpcRequest) Reset() {
	*x = RequestGenerateActionItensGrpcRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RequestGenerateActionItensGrpcRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestGenerateActionItensGrpcRequest) ProtoMessage() {}

func (x *RequestGenerateActionItensGrpcRequest) ProtoReflect() protoreflect.Message {
	mi := &file_interaction_event_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RequestGenerateActionItensGrpcRequest.ProtoReflect.Descriptor instead.
func (*RequestGenerateActionItensGrpcRequest) Descriptor() ([]byte, []int) {
	return file_interaction_event_proto_rawDescGZIP(), []int{1}
}

func (x *RequestGenerateActionItensGrpcRequest) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
func (x *RequestGenerateActionItensGrpcRequest) GetInteractionEventId() string {
	if x != nil {
		return x.InteractionEventId
	}
	return ""
...
var file_interaction_event_proto_rawDesc = []byte{
	...
	,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xe3, 0x01, 0x0a, 0x1b, 0x69,
	...
	0x74, 0x65, 0x6e, 0x73, 0x47, 0x72, 0x70, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x42, 0x57, 0x42, 0x15, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3c, 0x61, 0x70, 0x69,
	0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x3b, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x67, 0x72, 0x70,
...
var file_interaction_event_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_interaction_event_proto_goTypes = []interface{}{
	...
	(*RequestGenerateActionItensGrpcRequest)(nil), // 1: RequestGenerateActionItensGrpcRequest
	(*InteractionEventIdGrpcResponse)(nil),        // 2: InteractionEventIdGrpcResponse
}
var file_interaction_event_proto_depIdxs = []int32{
	...
	1, // 1: interactionEventGrpcService.RequestGenerateActionItems:input_type -> RequestGenerateActionItensGrpcRequest
	2, // 2: interactionEventGrpcService.RequestGenerateSummary:output_type -> InteractionEventIdGrpcResponse
	2, // 3: interactionEventGrpcService.RequestGenerateActionItems:output_type -> InteractionEventIdGrpcResponse
...
func file_interaction_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_interaction_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestGenerateActionItensGrpcRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
