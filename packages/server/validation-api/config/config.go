...
type IpDataConfig struct {
	...
	IpDataCacheTtlDays int    `env:"IPDATA_CACHE_TTL_DAYS" validate:"required"`
}
...
type EmailConfig struct {
	...
	EmailDomainValidationCacheTtlDays int    `env:"EMAIL_VALIDATION_DOMAIN_CACHE_TTL_DAYS" validate:"required"`
	EmailValidationCacheTtlDays       int    `env:"EMAIL_VALIDATION_CACHE_TTL_DAYS" validate:"required"`
}
