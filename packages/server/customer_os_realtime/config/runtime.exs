...
#
#     PHX_SERVER=true bin/customer_os_realtime start
#
...
if config_env() == :prod do
  ...
  config :customer_os_realtime, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :customer_os_realtime, CustomerOsRealtime.Mailer,
