...
type AgentService interface {
	...
	UpdateAgent(ctx context.Context, agentId string, agentFields data_fields.AgentFields, capabilities []postgres_entity.Capability) (*postgres_entity.Agent, error)
