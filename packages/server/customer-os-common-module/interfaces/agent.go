...
type AgentService interface {
	...
	SaveAgentConfig(ctx context.Context, agent *entity.Agents, agentConfig any) (*entity.Agents, error)
	AgentConfig(ctx context.Context, agent *entity.Agents) (any, error)
