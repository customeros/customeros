...
type QuickbooksService interface {
	...
	PayInvoice(ctx context.Context, customerId, invoiceId, invoiceNumber string, totalAmount float64, paymentIncomeAccountName string) (*QuickbooksSavePaymentResponse, error)
