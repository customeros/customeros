...
type UserService interface {
	...
	GetUsersByEmailIds(ctx context.Context, emailIds []string) (*neo4jentity.UserEntities, error)
	GetUsersByEmailAddresses(ctx context.Context, emailAddresses []string) (*neo4jentity.UserEntities, error)
	...
	GetUserCreatorsForTasks(ctx context.Context, taskIds []string) (*neo4jentity.UserEntities, error)
	GetUserAssigneesForTasks(ctx context.Context, taskIds []string) (*neo4jentity.UserEntities, error)
