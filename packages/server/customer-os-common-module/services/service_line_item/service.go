...
func (s *serviceLineItemService) Save(ctx context.Context, txWithPostCommit *utils.TxWithPostCommit, id *string, dataFields data_fields.SLIFields) (string, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.Save")
	defer spans.Finish()
	...
	_, err = utils.ExecuteWriteInTransactionWithPostCommitActions(ctx, s.neo4j.Neo4jDriver, s.neo4j.Database, txWithPostCommit, func(txWithPostCommit *utils.TxWithPostCommit) (any, error) {
		...
		txWithPostCommit.AddPostCommitAction(func(ctx context.Context) error {
			...
			if createFlow {
				...
				if err != nil {
					spans.TraceError(errors.Wrap(err, "unable to publish message CreateServiceLineItem for SLI"))
				}
				err = s.events.Publisher.PublishFanoutEvent(ctx, contractEntity.Id, model.CONTRACT, dto.CreateServiceLineItem{dataFields})
				if err != nil {
					spans.TraceError(errors.Wrap(err, "unable to publish message CreateServiceLineItem for Contract"))
				}
				...
				if err != nil {
					spans.TraceError(errors.Wrap(err, "unable to publish message UpdateServiceLineItem for SLI"))
				}
				err = s.events.Publisher.PublishFanoutEvent(ctx, contractEntity.Id, model.CONTRACT, dto.UpdateServiceLineItem{dataFields})
				if err != nil {
					spans.TraceError(errors.Wrap(err, "unable to publish message UpdateServiceLineItem for Contract"))
				}
...
func (s *serviceLineItemService) GetById(ctx context.Context, serviceLineItemId string) (*neo4jentity.ServiceLineItemEntity, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.GetById")
	defer spans.Finish()
...
func (s *serviceLineItemService) GetServiceLineItemsByParentId(ctx context.Context, sliParentId string) (*neo4jentity.ServiceLineItemEntities, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.GetServiceLineItemsByParentId")
	defer spans.Finish()

	spans.LogFields(log.Object("sliParentId", sliParentId))
...
func (s *serviceLineItemService) GetServiceLineItemsForContracts(ctx context.Context, contractIDs []string) (*neo4jentity.ServiceLineItemEntities, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.GetServiceLineItemsForContracts")
	defer spans.Finish()
...
func (s *serviceLineItemService) GetServiceLineItemsForInvoiceLines(ctx context.Context, invoiceLineIds []string) (*neo4jentity.ServiceLineItemEntities, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.GetServiceLineItemsForInvoiceLines")
	defer spans.Finish()
	spans.LogFields(log.Object("invoiceLineIds", invoiceLineIds))
...
func (s *serviceLineItemService) Pause(ctx context.Context, txWithPostCommit *utils.TxWithPostCommit, serviceLineItemId string) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.Pause")
	defer spans.Finish()
	...
	_, err = utils.ExecuteWriteInTransactionWithPostCommitActions(ctx, s.neo4j.Neo4jDriver, s.neo4j.Database, txWithPostCommit, func(txWithPostCommit *utils.TxWithPostCommit) (any, error) {
		...
		txWithPostCommit.AddPostCommitAction(func(ctx context.Context) error {
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message PauseServiceLineItem"))
			}
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message PauseServiceLineItem for contract"))
			}
...
func (s *serviceLineItemService) Resume(ctx context.Context, txWithPostCommit *utils.TxWithPostCommit, serviceLineItemId string) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.Resume")
	defer spans.Finish()
	...
	_, err = utils.ExecuteWriteInTransactionWithPostCommitActions(ctx, s.neo4j.Neo4jDriver, s.neo4j.Database, txWithPostCommit, func(txWithPostCommit *utils.TxWithPostCommit) (any, error) {
		...
		txWithPostCommit.AddPostCommitAction(func(ctx context.Context) error {
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message ResumeServiceLineItem"))
			}
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message ResumeServiceLineItem for contract"))
			}
...
func (s *serviceLineItemService) Delete(ctx context.Context, txWithPostCommit *utils.TxWithPostCommit, serviceLineItemId string) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.Delete")
	defer spans.Finish()
	...
	_, err = utils.ExecuteWriteInTransactionWithPostCommitActions(ctx, s.neo4j.Neo4jDriver, s.neo4j.Database, txWithPostCommit, func(txWithPostCommit *utils.TxWithPostCommit) (any, error) {
		...
		txWithPostCommit.AddPostCommitAction(func(ctx context.Context) error {
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message DeleteServiceLineItem"))
			}
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message DeleteServiceLineItem for contract"))
			}
...
func (s *serviceLineItemService) Close(ctx context.Context, txWithPostCommit *utils.TxWithPostCommit, serviceLineItemId string, endedAt time.Time) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.Close")
	defer spans.Finish()
	...
	_, err = utils.ExecuteWriteInTransactionWithPostCommitActions(ctx, s.neo4j.Neo4jDriver, s.neo4j.Database, txWithPostCommit, func(txWithPostCommit *utils.TxWithPostCommit) (any, error) {
		...
		txWithPostCommit.AddPostCommitAction(func(ctx context.Context) error {
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message CloseServiceLineItem"))
			}
			...
			if err != nil {
				spans.TraceError(errors.Wrap(err, "unable to publish message CloseServiceLineItem for contract"))
			}
...
func (s *serviceLineItemService) GetServiceLineItemName(ctx context.Context, sliId string) (string, error) {
	spans, ctx := telemetry.StartServiceSpan(ctx, "ServiceLineItemService.GetServiceLineItemName")
	defer spans.Finish()
