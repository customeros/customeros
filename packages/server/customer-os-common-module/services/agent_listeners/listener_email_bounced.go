...
func (l *EmailBouncedListener) Handle(ctx context.Context, baseEvent any) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "EmailBouncedListener.Handle")
	defer spans.Finish()
...
func (l *EmailBouncedListener) handleExecution(ctx context.Context, orgID string) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "EmailBouncedListener.handleExecution")
	defer spans.Finish()
...
func (l *EmailBouncedListener) run(ctx context.Context, agent postgres_entity.Agent, startParams any) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "EmailBouncedListener.run")
	defer spans.Finish()
...
func (l *EmailBouncedListener) handleGoalAchieved(ctx context.Context, agentExecutionId string) error {
	spans, ctx := telemetry.StartServiceSpan(ctx, "EmailBouncedListener.handleGoalAchieved")
	defer spans.Finish()
...
func (l *EmailBouncedListener) lookupActiveAgents(ctx context.Context) []postgres_entity.Agent {
	spans, ctx := telemetry.StartServiceSpan(ctx, "EmailBouncedListener.lookupActiveAgents")
	defer spans.Finish()
