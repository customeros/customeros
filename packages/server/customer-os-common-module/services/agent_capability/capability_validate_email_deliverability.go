...
func (c *ValidateEmailDeliverabilityCapability) Execute(ctx context.Context, executionContainer interfaces.TypedExecutionContainer[ValidateEmailDeliverabilityInput, ValidateEmailDeliverabilityConfig]) (bool, ValidateEmailDeliverabilityOutput, error) {
