...
func InitCapabilities(
	...
	capabilities = append(capabilities, NewUpdateCompanyStatusCapability(postgresRepositories, events, organizationService))
	...
	capabilities = append(capabilities, NewClassifyEmailCapability(postgresRepositories, events, mailService))
	...
	capabilities = append(capabilities, NewIngestEmailCapability(postgresRepositories, events, mailService, opensearchService))
