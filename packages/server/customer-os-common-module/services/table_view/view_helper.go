	...
	case postgres_entity.TableIDTypeCustomers:
		return postgres_entity.Columns{
			Columns: []postgres_entity.ColumnView{
				...
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIcpFit), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 11, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsStage), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 12, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIsPublic), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 13, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsEmployeeCount), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 14, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsYearFounded), Width: 100, Visible: false, Name: "", Filter: ""},
	...
	case postgres_entity.TableIDTypeOrganizations:
		return postgres_entity.Columns{
			Columns: []postgres_entity.ColumnView{
				...
				{ColumnId: 11, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsOwner), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 12, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIsPublic), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 13, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsEmployeeCount), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 14, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsYearFounded), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 15, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsContactCount), Width: 100, Visible: false, Name: "", Filter: ""},
