...
func DefaultColumns(tableId postgres_entity.TableIdType) postgres_entity.Columns {
	...
	case postgres_entity.TableIDTypeCustomers:
		return postgres_entity.Columns{
			Columns: []postgres_entity.ColumnView{
				...
				{ColumnId: 3, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIcpFit), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 4, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsStage), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIsPublic), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsEmployeeCount), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsYearFounded), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsContactCount), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsLeadSource), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsCreatedDate), Width: 100, Visible: false, Name: "", Filter: ""},
			},
		}
	case postgres_entity.TableIDTypeOrganizations:
		return postgres_entity.Columns{
			Columns: []postgres_entity.ColumnView{
				...
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsOwner), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsIsPublic), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsEmployeeCount), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsYearFounded), Width: 100, Visible: false, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeOrganizationsContactCount), Width: 100, Visible: false, Name: "", Filter: ""},
	...
	case postgres_entity.TableIDTypePastInvoices:
		return postgres_entity.Columns{
			Columns: []postgres_entity.ColumnView{
				{ColumnId: 1, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesInvoiceNumber), Width: 130, Visible: true, Name: "", Filter: ""},
				{ColumnId: 2, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesContract), Width: 200, Visible: true, Name: "", Filter: ""},
				{ColumnId: 10, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesOrganization), Width: 140, Visible: true, Name: "", Filter: ""},
				{ColumnId: 3, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesBillingCycle), Width: 120, Visible: true, Name: "", Filter: ""},
				{ColumnId: 4, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesIssueDatePast), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 8, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesIssueDate), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 5, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesDueDate), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 6, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesAmount), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 9, ColumnType: string(postgres_entity.ColumnViewTypeInvoicesInvoiceStatus), Width: 100, Visible: true, Name: "", Filter: ""},
			},
		}
