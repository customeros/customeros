...
func TenantUserContextEnhancer(cr *neo4jrepository.Repositories, opts ...CommonServiceOption) func(c *gin.Context) {
	...
	return func(c *gin.Context) {
		spans, ctx := telemetry.StartServiceSpan(c.Request.Context(), "TenantUserContextEnhancer")
		defer spans.Finish()
		...
		spans.LogKV("header.tenant", tenantHeader)
		spans.LogKV("header.username", usernameHeader)
