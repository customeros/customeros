...
const (
	...
	EventInvoicePastDue                 AgentListenerEvent = "invoice_past_due"
	EventInvoicePaymentFailed           AgentListenerEvent = "payment_failed"
	EventInvoicePaymentProcessing       AgentListenerEvent = "payment_processing"
