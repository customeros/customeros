  ...
  def ask(%AskAIRequest{} = message) do
    case message.model do
      model when model in [:claude_haiku, :claude_sonnet] ->
        anthropic_request = %Ai.Anthropic.Models.AskAIRequest{
          model: message.model,
        ...
        Ai.Anthropic.Service.ask(anthropic_request, Ai.Anthropic.Config.from_application_env())
