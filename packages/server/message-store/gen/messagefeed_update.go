...
func (mfu *MessageFeedUpdate) SetContactId(s string) *MessageFeedUpdate {
	mfu.mutation.SetContactId(s)
	return mfu
}

// SetFirstName sets the "firstName" field.
func (mfu *MessageFeedUpdate) SetFirstName(s string) *MessageFeedUpdate {
	mfu.mutation.SetFirstName(s)
	return mfu
}

// SetLastName sets the "lastName" field.
func (mfu *MessageFeedUpdate) SetLastName(s string) *MessageFeedUpdate {
	mfu.mutation.SetLastName(s)
	return mfu
}
...
func (mfu *MessageFeedUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mfu.mutation.ContactId(); ok {
	...
	if value, ok := mfu.mutation.FirstName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := mfu.mutation.LastName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
...
// SetContactId sets the "contactId" field.
func (mfuo *MessageFeedUpdateOne) SetContactId(s string) *MessageFeedUpdateOne {
	mfuo.mutation.SetContactId(s)
	return mfuo
}

// SetFirstName sets the "firstName" field.
func (mfuo *MessageFeedUpdateOne) SetFirstName(s string) *MessageFeedUpdateOne {
	mfuo.mutation.SetFirstName(s)
	return mfuo
}

// SetLastName sets the "lastName" field.
func (mfuo *MessageFeedUpdateOne) SetLastName(s string) *MessageFeedUpdateOne {
	mfuo.mutation.SetLastName(s)
	return mfuo
}
...
func (mfuo *MessageFeedUpdateOne) sqlSave(ctx context.Context) (_node *MessageFeed, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "MessageFeed.id" for update`)}
	}
	...
	if value, ok := mfuo.mutation.ContactId(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: messagefeed.FieldContactId,
	...
	if value, ok := mfuo.mutation.FirstName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: messagefeed.FieldFirstName,
	...
	if value, ok := mfuo.mutation.LastName(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: messagefeed.FieldLastName,
