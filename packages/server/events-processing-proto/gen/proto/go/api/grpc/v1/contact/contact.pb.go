...
var file_contact_proto_rawDesc = []byte{
	...
	0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x96, 0x01, 0x0a,
	0x18, 0x45, 0x6e, 0x72, 0x69, 0x63, 0x68, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63, 0x74, 0x47, 0x72,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xc6, 0x02, 0x0a, 0x1d, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xab, 0x04, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x63, 0x74, 0x47, 0x72, 0x70, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x58,
...
var file_contact_proto_goTypes = []any{
	...
	(*ContactAddSocialGrpcRequest)(nil),         // 3: ContactAddSocialGrpcRequest
	(*ContactRemoveSocialGrpcRequest)(nil),      // 4: ContactRemoveSocialGrpcRequest
	(*EnrichContactGrpcRequest)(nil),            // 5: EnrichContactGrpcRequest
	(*ContactAddLocationGrpcRequest)(nil),       // 6: ContactAddLocationGrpcRequest
	(*ContactIdGrpcResponse)(nil),               // 7: ContactIdGrpcResponse
	(*common.SourceFields)(nil),                 // 8: SourceFields
	(*timestamppb.Timestamp)(nil),               // 9: google.protobuf.Timestamp
	(*location.LocationDetails)(nil),            // 10: LocationDetails
	(*social.SocialIdGrpcResponse)(nil),         // 11: SocialIdGrpcResponse
	(*location.LocationIdGrpcResponse)(nil),     // 12: LocationIdGrpcResponse
}
var file_contact_proto_depIdxs = []int32{
	8,  // 0: LinkWithOrganizationGrpcRequest.sourceFields:type_name -> SourceFields
	9,  // 1: LinkWithOrganizationGrpcRequest.startedAt:type_name -> google.protobuf.Timestamp
	9,  // 2: LinkWithOrganizationGrpcRequest.endedAt:type_name -> google.protobuf.Timestamp
	9,  // 3: LinkWithOrganizationGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	9,  // 4: LinkWithOrganizationGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	8,  // 5: ContactAddSocialGrpcRequest.sourceFields:type_name -> SourceFields
	9,  // 6: ContactAddSocialGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	8,  // 7: ContactAddLocationGrpcRequest.sourceFields:type_name -> SourceFields
	10, // 8: ContactAddLocationGrpcRequest.locationDetails:type_name -> LocationDetails
	9,  // 9: ContactAddLocationGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	0,  // 10: contactGrpcService.LinkPhoneNumberToContact:input_type -> LinkPhoneNumberToContactGrpcRequest
	1,  // 11: contactGrpcService.LinkLocationToContact:input_type -> LinkLocationToContactGrpcRequest
	2,  // 12: contactGrpcService.LinkWithOrganization:input_type -> LinkWithOrganizationGrpcRequest
	3,  // 13: contactGrpcService.AddSocial:input_type -> ContactAddSocialGrpcRequest
	4,  // 14: contactGrpcService.RemoveSocial:input_type -> ContactRemoveSocialGrpcRequest
	5,  // 15: contactGrpcService.EnrichContact:input_type -> EnrichContactGrpcRequest
	6,  // 16: contactGrpcService.AddLocation:input_type -> ContactAddLocationGrpcRequest
	7,  // 17: contactGrpcService.LinkPhoneNumberToContact:output_type -> ContactIdGrpcResponse
	7,  // 18: contactGrpcService.LinkLocationToContact:output_type -> ContactIdGrpcResponse
	7,  // 19: contactGrpcService.LinkWithOrganization:output_type -> ContactIdGrpcResponse
	11, // 20: contactGrpcService.AddSocial:output_type -> SocialIdGrpcResponse
	7,  // 21: contactGrpcService.RemoveSocial:output_type -> ContactIdGrpcResponse
	7,  // 22: contactGrpcService.EnrichContact:output_type -> ContactIdGrpcResponse
	12, // 23: contactGrpcService.AddLocation:output_type -> LocationIdGrpcResponse
