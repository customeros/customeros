...
type InvoiceGrpcServiceClient interface {
	...
	SimulateInvoice(ctx context.Context, in *NewInvoiceRequest, opts ...grpc.CallOption) (*InvoiceIdResponse, error)
}
...
func (c *invoiceGrpcServiceClient) SimulateInvoice(ctx context.Context, in *NewInvoiceRequest, opts ...grpc.CallOption) (*InvoiceIdResponse, error) {
	out := new(InvoiceIdResponse)
...
type InvoiceGrpcServiceServer interface {
	...
	SimulateInvoice(context.Context, *NewInvoiceRequest) (*InvoiceIdResponse, error)
}
...
func (UnimplementedInvoiceGrpcServiceServer) SimulateInvoice(context.Context, *NewInvoiceRequest) (*InvoiceIdResponse, error) {
...
func _InvoiceGrpcService_SimulateInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceGrpcServiceServer).SimulateInvoice(ctx, req.(*NewInvoiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
