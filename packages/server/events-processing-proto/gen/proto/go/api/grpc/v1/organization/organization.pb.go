...
var file_organization_proto_rawDesc = []byte{
	...
	0x06, 0x32, 0xef, 0x0f, 0x0a, 0x17, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69,
...
var file_organization_proto_depIdxs = []int32{
	...
	3,  // 21: organizationGrpcService.ShowOrganization:input_type -> OrganizationIdGrpcRequest
	4,  // 22: organizationGrpcService.RefreshRenewalSummary:input_type -> RefreshRenewalSummaryGrpcRequest
	5,  // 23: organizationGrpcService.RefreshDerivedData:input_type -> RefreshDerivedDataGrpcRequest
	3,  // 24: organizationGrpcService.RefreshArr:input_type -> OrganizationIdGrpcRequest
	15, // 25: organizationGrpcService.AddParentOrganization:input_type -> AddParentOrganizationGrpcRequest
	16, // 26: organizationGrpcService.RemoveParentOrganization:input_type -> RemoveParentOrganizationGrpcRequest
	18, // 27: organizationGrpcService.UpdateOnboardingStatus:input_type -> UpdateOnboardingStatusGrpcRequest
	19, // 28: organizationGrpcService.RemoveSocial:input_type -> RemoveSocialGrpcRequest
	20, // 29: organizationGrpcService.UpdateOrganizationOwner:input_type -> UpdateOrganizationOwnerGrpcRequest
	21, // 30: organizationGrpcService.CreateBillingProfile:input_type -> CreateBillingProfileGrpcRequest
	22, // 31: organizationGrpcService.UpdateBillingProfile:input_type -> UpdateBillingProfileGrpcRequest
	7,  // 32: organizationGrpcService.LinkEmailToBillingProfile:input_type -> LinkEmailToBillingProfileGrpcRequest
	8,  // 33: organizationGrpcService.UnlinkEmailFromBillingProfile:input_type -> UnlinkEmailFromBillingProfileGrpcRequest
	10, // 34: organizationGrpcService.LinkLocationToBillingProfile:input_type -> LinkLocationToBillingProfileGrpcRequest
	11, // 35: organizationGrpcService.UnlinkLocationFromBillingProfile:input_type -> UnlinkLocationFromBillingProfileGrpcRequest
	25, // 36: organizationGrpcService.AddLocation:input_type -> OrganizationAddLocationGrpcRequest
	3,  // 37: organizationGrpcService.AdjustIndustry:input_type -> OrganizationIdGrpcRequest
	26, // 38: organizationGrpcService.EnrichOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 39: organizationGrpcService.LinkPhoneNumberToOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 40: organizationGrpcService.LinkLocationToOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 41: organizationGrpcService.UnlinkDomainFromOrganization:output_type -> OrganizationIdGrpcResponse
	27, // 42: organizationGrpcService.UpsertCustomFieldToOrganization:output_type -> CustomFieldIdGrpcResponse
	26, // 43: organizationGrpcService.ShowOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 44: organizationGrpcService.RefreshRenewalSummary:output_type -> OrganizationIdGrpcResponse
	26, // 45: organizationGrpcService.RefreshDerivedData:output_type -> OrganizationIdGrpcResponse
	26, // 46: organizationGrpcService.RefreshArr:output_type -> OrganizationIdGrpcResponse
	26, // 47: organizationGrpcService.AddParentOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 48: organizationGrpcService.RemoveParentOrganization:output_type -> OrganizationIdGrpcResponse
	26, // 49: organizationGrpcService.UpdateOnboardingStatus:output_type -> OrganizationIdGrpcResponse
	26, // 50: organizationGrpcService.RemoveSocial:output_type -> OrganizationIdGrpcResponse
	26, // 51: organizationGrpcService.UpdateOrganizationOwner:output_type -> OrganizationIdGrpcResponse
	28, // 52: organizationGrpcService.CreateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	28, // 53: organizationGrpcService.UpdateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	28, // 54: organizationGrpcService.LinkEmailToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	28, // 55: organizationGrpcService.UnlinkEmailFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	28, // 56: organizationGrpcService.LinkLocationToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	28, // 57: organizationGrpcService.UnlinkLocationFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 58: organizationGrpcService.AddLocation:output_type -> LocationIdGrpcResponse
	26, // 59: organizationGrpcService.AdjustIndustry:output_type -> OrganizationIdGrpcResponse
