...
var file_organization_proto_rawDesc = []byte{
	...
	0x53, 0x5f, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x46, 0x55, 0x4c, 0x10, 0x06, 0x32, 0xd0,
	0x11, 0x0a, 0x17, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x47,
...
var file_organization_proto_depIdxs = []int32{
	...
	7,  // 33: organizationGrpcService.RefreshRenewalSummary:input_type -> RefreshRenewalSummaryGrpcRequest
	8,  // 34: organizationGrpcService.RefreshDerivedData:input_type -> RefreshDerivedDataGrpcRequest
	6,  // 35: organizationGrpcService.RefreshArr:input_type -> OrganizationIdGrpcRequest
	18, // 36: organizationGrpcService.AddParentOrganization:input_type -> AddParentOrganizationGrpcRequest
	19, // 37: organizationGrpcService.RemoveParentOrganization:input_type -> RemoveParentOrganizationGrpcRequest
	21, // 38: organizationGrpcService.UpdateOnboardingStatus:input_type -> UpdateOnboardingStatusGrpcRequest
	5,  // 39: organizationGrpcService.UpdateOrganization:input_type -> UpdateOrganizationGrpcRequest
	22, // 40: organizationGrpcService.AddSocial:input_type -> AddSocialGrpcRequest
	23, // 41: organizationGrpcService.RemoveSocial:input_type -> RemoveSocialGrpcRequest
	24, // 42: organizationGrpcService.UpdateOrganizationOwner:input_type -> UpdateOrganizationOwnerGrpcRequest
	25, // 43: organizationGrpcService.CreateBillingProfile:input_type -> CreateBillingProfileGrpcRequest
	26, // 44: organizationGrpcService.UpdateBillingProfile:input_type -> UpdateBillingProfileGrpcRequest
	10, // 45: organizationGrpcService.LinkEmailToBillingProfile:input_type -> LinkEmailToBillingProfileGrpcRequest
	11, // 46: organizationGrpcService.UnlinkEmailFromBillingProfile:input_type -> UnlinkEmailFromBillingProfileGrpcRequest
	13, // 47: organizationGrpcService.LinkLocationToBillingProfile:input_type -> LinkLocationToBillingProfileGrpcRequest
	14, // 48: organizationGrpcService.UnlinkLocationFromBillingProfile:input_type -> UnlinkLocationFromBillingProfileGrpcRequest
	29, // 49: organizationGrpcService.AddLocation:input_type -> OrganizationAddLocationGrpcRequest
	6,  // 50: organizationGrpcService.AdjustIndustry:input_type -> OrganizationIdGrpcRequest
	30, // 51: organizationGrpcService.UpsertOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 52: organizationGrpcService.EnrichOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 53: organizationGrpcService.LinkPhoneNumberToOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 54: organizationGrpcService.LinkLocationToOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 55: organizationGrpcService.UnlinkDomainFromOrganization:output_type -> OrganizationIdGrpcResponse
	31, // 56: organizationGrpcService.UpsertCustomFieldToOrganization:output_type -> CustomFieldIdGrpcResponse
	30, // 57: organizationGrpcService.ShowOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 58: organizationGrpcService.RefreshRenewalSummary:output_type -> OrganizationIdGrpcResponse
	30, // 59: organizationGrpcService.RefreshDerivedData:output_type -> OrganizationIdGrpcResponse
	30, // 60: organizationGrpcService.RefreshArr:output_type -> OrganizationIdGrpcResponse
	30, // 61: organizationGrpcService.AddParentOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 62: organizationGrpcService.RemoveParentOrganization:output_type -> OrganizationIdGrpcResponse
	30, // 63: organizationGrpcService.UpdateOnboardingStatus:output_type -> OrganizationIdGrpcResponse
	30, // 64: organizationGrpcService.UpdateOrganization:output_type -> OrganizationIdGrpcResponse
	37, // 65: organizationGrpcService.AddSocial:output_type -> SocialIdGrpcResponse
	30, // 66: organizationGrpcService.RemoveSocial:output_type -> OrganizationIdGrpcResponse
	30, // 67: organizationGrpcService.UpdateOrganizationOwner:output_type -> OrganizationIdGrpcResponse
	32, // 68: organizationGrpcService.CreateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 69: organizationGrpcService.UpdateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 70: organizationGrpcService.LinkEmailToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 71: organizationGrpcService.UnlinkEmailFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 72: organizationGrpcService.LinkLocationToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	32, // 73: organizationGrpcService.UnlinkLocationFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	38, // 74: organizationGrpcService.AddLocation:output_type -> LocationIdGrpcResponse
	30, // 75: organizationGrpcService.AdjustIndustry:output_type -> OrganizationIdGrpcResponse
