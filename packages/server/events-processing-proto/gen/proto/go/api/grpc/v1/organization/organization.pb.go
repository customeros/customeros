...
var file_organization_proto_rawDesc = []byte{
	...
	0x06, 0x32, 0xd0, 0x09, 0x0a, 0x17, 0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x47, 0x72, 0x70, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x65, 0x0a,
...
var file_organization_proto_goTypes = []any{
	...
	(*UpdateOnboardingStatusGrpcRequest)(nil),           // 13: UpdateOnboardingStatusGrpcRequest
	(*UpdateOrganizationOwnerGrpcRequest)(nil),          // 14: UpdateOrganizationOwnerGrpcRequest
	(*CreateBillingProfileGrpcRequest)(nil),             // 15: CreateBillingProfileGrpcRequest
	(*UpdateBillingProfileGrpcRequest)(nil),             // 16: UpdateBillingProfileGrpcRequest
	(*OrganizationAddTagGrpcRequest)(nil),               // 17: OrganizationAddTagGrpcRequest
	(*OrganizationRemoveTagGrpcRequest)(nil),            // 18: OrganizationRemoveTagGrpcRequest
...
var file_organization_proto_depIdxs = []int32{
	22, // 0: CustomFieldValue.datetimeValue:type_name -> google.protobuf.Timestamp
	...
	23, // 3: CustomFieldForOrganizationGrpcRequest.sourceFields:type_name -> SourceFields
	22, // 4: CustomFieldForOrganizationGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	22, // 5: CustomFieldForOrganizationGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	2,  // 6: UpdateOnboardingStatusGrpcRequest.onboardingStatus:type_name -> OnboardingStatus
	22, // 7: UpdateOnboardingStatusGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	23, // 8: CreateBillingProfileGrpcRequest.sourceFields:type_name -> SourceFields
	22, // 9: CreateBillingProfileGrpcRequest.createdAt:type_name -> google.protobuf.Timestamp
	22, // 10: CreateBillingProfileGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	22, // 11: UpdateBillingProfileGrpcRequest.updatedAt:type_name -> google.protobuf.Timestamp
	0,  // 12: UpdateBillingProfileGrpcRequest.fieldsMask:type_name -> BillingProfileFieldMask
	12, // 13: organizationGrpcService.UpsertCustomFieldToOrganization:input_type -> CustomFieldForOrganizationGrpcRequest
	4,  // 14: organizationGrpcService.RefreshRenewalSummary:input_type -> RefreshRenewalSummaryGrpcRequest
	5,  // 15: organizationGrpcService.RefreshDerivedData:input_type -> RefreshDerivedDataGrpcRequest
	3,  // 16: organizationGrpcService.RefreshArr:input_type -> OrganizationIdGrpcRequest
	13, // 17: organizationGrpcService.UpdateOnboardingStatus:input_type -> UpdateOnboardingStatusGrpcRequest
	14, // 18: organizationGrpcService.UpdateOrganizationOwner:input_type -> UpdateOrganizationOwnerGrpcRequest
	15, // 19: organizationGrpcService.CreateBillingProfile:input_type -> CreateBillingProfileGrpcRequest
	16, // 20: organizationGrpcService.UpdateBillingProfile:input_type -> UpdateBillingProfileGrpcRequest
	6,  // 21: organizationGrpcService.LinkEmailToBillingProfile:input_type -> LinkEmailToBillingProfileGrpcRequest
	7,  // 22: organizationGrpcService.UnlinkEmailFromBillingProfile:input_type -> UnlinkEmailFromBillingProfileGrpcRequest
	9,  // 23: organizationGrpcService.LinkLocationToBillingProfile:input_type -> LinkLocationToBillingProfileGrpcRequest
	10, // 24: organizationGrpcService.UnlinkLocationFromBillingProfile:input_type -> UnlinkLocationFromBillingProfileGrpcRequest
	3,  // 25: organizationGrpcService.AdjustIndustry:input_type -> OrganizationIdGrpcRequest
	20, // 26: organizationGrpcService.UpsertCustomFieldToOrganization:output_type -> CustomFieldIdGrpcResponse
	19, // 27: organizationGrpcService.RefreshRenewalSummary:output_type -> OrganizationIdGrpcResponse
	19, // 28: organizationGrpcService.RefreshDerivedData:output_type -> OrganizationIdGrpcResponse
	19, // 29: organizationGrpcService.RefreshArr:output_type -> OrganizationIdGrpcResponse
	19, // 30: organizationGrpcService.UpdateOnboardingStatus:output_type -> OrganizationIdGrpcResponse
	19, // 31: organizationGrpcService.UpdateOrganizationOwner:output_type -> OrganizationIdGrpcResponse
	21, // 32: organizationGrpcService.CreateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	21, // 33: organizationGrpcService.UpdateBillingProfile:output_type -> BillingProfileIdGrpcResponse
	21, // 34: organizationGrpcService.LinkEmailToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	21, // 35: organizationGrpcService.UnlinkEmailFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	21, // 36: organizationGrpcService.LinkLocationToBillingProfile:output_type -> BillingProfileIdGrpcResponse
	21, // 37: organizationGrpcService.UnlinkLocationFromBillingProfile:output_type -> BillingProfileIdGrpcResponse
	19, // 38: organizationGrpcService.AdjustIndustry:output_type -> OrganizationIdGrpcResponse
