...
var file_invoice_proto_rawDesc = []byte{
	...
	,
	...
	0x53, 0x5f, 0x50, 0x41, 0x49, 0x44, 0x10, 0x03, 0x32, 0x9c, 0x03, 0x0a, 0x12, 0x49, 0x6e, 0x76,
...
var file_invoice_proto_goTypes = []interface{}{
	...
	(*NewInvoiceForContractRequest)(nil), // 1: NewInvoiceForContractRequest
	(*FillInvoiceRequest)(nil),           // 2: FillInvoiceRequest
	(*InvoiceLine)(nil),                  // 3: InvoiceLine
	(*GenerateInvoicePdfRequest)(nil),    // 4: GenerateInvoicePdfRequest
	(*PayInvoiceRequest)(nil),            // 5: PayInvoiceRequest
	(*PdfGeneratedInvoiceRequest)(nil),   // 6: PdfGeneratedInvoiceRequest
	(*SimulateInvoiceRequest)(nil),       // 7: SimulateInvoiceRequest
	(*DryRunServiceLineItem)(nil),        // 8: DryRunServiceLineItem
	(*InvoiceIdResponse)(nil),            // 9: InvoiceIdResponse
	(*timestamppb.Timestamp)(nil),        // 10: google.protobuf.Timestamp
	(*common.SourceFields)(nil),          // 11: SourceFields
	(common.BillingCycle)(0),             // 12: BillingCycle
	(common.BilledType)(0),               // 13: BilledType
}
var file_invoice_proto_depIdxs = []int32{
	10, // 0: NewInvoiceForContractRequest.createdAt:type_name -> google.protobuf.Timestamp
	11, // 1: NewInvoiceForContractRequest.sourceFields:type_name -> SourceFields
	10, // 2: NewInvoiceForContractRequest.invoicePeriodStart:type_name -> google.protobuf.Timestamp
	10, // 3: NewInvoiceForContractRequest.invoicePeriodEnd:type_name -> google.protobuf.Timestamp
	12, // 4: NewInvoiceForContractRequest.billingCycle:type_name -> BillingCycle
	3,  // 5: FillInvoiceRequest.invoiceLines:type_name -> InvoiceLine
	10, // 6: FillInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	0,  // 7: FillInvoiceRequest.status:type_name -> InvoiceStatus
	13, // 8: InvoiceLine.billedType:type_name -> BilledType
	10, // 9: PayInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	11, // 10: PayInvoiceRequest.sourceFields:type_name -> SourceFields
	10, // 11: PdfGeneratedInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	10, // 12: SimulateInvoiceRequest.date:type_name -> google.protobuf.Timestamp
	8,  // 13: SimulateInvoiceRequest.dryRunServiceLineItems:type_name -> DryRunServiceLineItem
	10, // 14: SimulateInvoiceRequest.createdAt:type_name -> google.protobuf.Timestamp
	11, // 15: SimulateInvoiceRequest.sourceFields:type_name -> SourceFields
	13, // 16: DryRunServiceLineItem.billed:type_name -> BilledType
	1,  // 17: InvoiceGrpcService.NewInvoiceForContract:input_type -> NewInvoiceForContractRequest
	2,  // 18: InvoiceGrpcService.FillInvoice:input_type -> FillInvoiceRequest
	4,  // 19: InvoiceGrpcService.GenerateInvoicePdf:input_type -> GenerateInvoicePdfRequest
	6,  // 20: InvoiceGrpcService.PdfGeneratedInvoice:input_type -> PdfGeneratedInvoiceRequest
	5,  // 21: InvoiceGrpcService.PayInvoice:input_type -> PayInvoiceRequest
	7,  // 22: InvoiceGrpcService.SimulateInvoice:input_type -> SimulateInvoiceRequest
	9,  // 23: InvoiceGrpcService.NewInvoiceForContract:output_type -> InvoiceIdResponse
	9,  // 24: InvoiceGrpcService.FillInvoice:output_type -> InvoiceIdResponse
	9,  // 25: InvoiceGrpcService.GenerateInvoicePdf:output_type -> InvoiceIdResponse
	9,  // 26: InvoiceGrpcService.PdfGeneratedInvoice:output_type -> InvoiceIdResponse
	9,  // 27: InvoiceGrpcService.PayInvoice:output_type -> InvoiceIdResponse
	9,  // 28: InvoiceGrpcService.SimulateInvoice:output_type -> InvoiceIdResponse
