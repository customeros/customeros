...
var file_invoice_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x9c, 0x03, 0x0a, 0x12,
...
var file_invoice_proto_goTypes = []interface{}{
	...
	(*GenerateInvoicePdfRequest)(nil),    // 3: GenerateInvoicePdfRequest
	(*PayInvoiceRequest)(nil),            // 4: PayInvoiceRequest
	(*PdfGeneratedInvoiceRequest)(nil),   // 5: PdfGeneratedInvoiceRequest
	(*SimulateInvoiceRequest)(nil),       // 6: SimulateInvoiceRequest
	(*DryRunServiceLineItem)(nil),        // 7: DryRunServiceLineItem
	(*InvoiceIdResponse)(nil),            // 8: InvoiceIdResponse
	(*timestamppb.Timestamp)(nil),        // 9: google.protobuf.Timestamp
	(*common.SourceFields)(nil),          // 10: SourceFields
	(common.BillingCycle)(0),             // 11: BillingCycle
	(common.BilledType)(0),               // 12: BilledType
}
var file_invoice_proto_depIdxs = []int32{
	9,  // 0: NewInvoiceForContractRequest.createdAt:type_name -> google.protobuf.Timestamp
	10, // 1: NewInvoiceForContractRequest.sourceFields:type_name -> SourceFields
	9,  // 2: NewInvoiceForContractRequest.invoicePeriodStart:type_name -> google.protobuf.Timestamp
	9,  // 3: NewInvoiceForContractRequest.invoicePeriodEnd:type_name -> google.protobuf.Timestamp
	11, // 4: NewInvoiceForContractRequest.billingCycle:type_name -> BillingCycle
	2,  // 5: FillInvoiceRequest.invoiceLines:type_name -> InvoiceLine
	9,  // 6: FillInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	12, // 7: InvoiceLine.billedType:type_name -> BilledType
	9,  // 8: PayInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	10, // 9: PayInvoiceRequest.sourceFields:type_name -> SourceFields
	9,  // 10: PdfGeneratedInvoiceRequest.updatedAt:type_name -> google.protobuf.Timestamp
	9,  // 11: SimulateInvoiceRequest.date:type_name -> google.protobuf.Timestamp
	7,  // 12: SimulateInvoiceRequest.dryRunServiceLineItems:type_name -> DryRunServiceLineItem
	9,  // 13: SimulateInvoiceRequest.createdAt:type_name -> google.protobuf.Timestamp
	10, // 14: SimulateInvoiceRequest.sourceFields:type_name -> SourceFields
	12, // 15: DryRunServiceLineItem.billed:type_name -> BilledType
	...
	3,  // 18: InvoiceGrpcService.GenerateInvoicePdf:input_type -> GenerateInvoicePdfRequest
	5,  // 19: InvoiceGrpcService.PdfGeneratedInvoice:input_type -> PdfGeneratedInvoiceRequest
	4,  // 20: InvoiceGrpcService.PayInvoice:input_type -> PayInvoiceRequest
	6,  // 21: InvoiceGrpcService.SimulateInvoice:input_type -> SimulateInvoiceRequest
	8,  // 22: InvoiceGrpcService.NewInvoiceForContract:output_type -> InvoiceIdResponse
	8,  // 23: InvoiceGrpcService.FillInvoice:output_type -> InvoiceIdResponse
	8,  // 24: InvoiceGrpcService.GenerateInvoicePdf:output_type -> InvoiceIdResponse
	8,  // 25: InvoiceGrpcService.PdfGeneratedInvoice:output_type -> InvoiceIdResponse
	8,  // 26: InvoiceGrpcService.PayInvoice:output_type -> InvoiceIdResponse
	8,  // 27: InvoiceGrpcService.SimulateInvoice:output_type -> InvoiceIdResponse
