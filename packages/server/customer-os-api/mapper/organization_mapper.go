...
func MapEntityToOrganization(entity *neo4jentity.OrganizationEntity) *model.Organization {
	...
	organization := model.Organization{
		...
		QualificationStatus: utils.ToPtr(enummapper.MapStatusToModel(entity.QualificationStatus)),
		QualifiedBy:         utils.ToPtr(enummapper.MapQualifiedByToModel(entity.QualifiedBy)),
