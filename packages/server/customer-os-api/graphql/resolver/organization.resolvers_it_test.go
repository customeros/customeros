...
func TestQueryResolver_Organization_WithTimelineEvents_DirectAndFromMultipleContacts(t *testing.T) {
	...
	issueId1 := neo4jt.CreateIssue(ctx, driver, tenantName, neo4jentity.IssueEntity{
		Subject:     "subject 1",
		CreatedAt:   secAgo80,
		Priority:    "P1",
		Status:      "OPEN",
	...
	issueId2 := neo4jt.CreateIssue(ctx, driver, tenantName, neo4jentity.IssueEntity{CreatedAt: secAgo1000})
	neo4jt.IssueReportedBy(ctx, driver, issueId2, organizationId)
	issueId3 := neo4jt.CreateIssue(ctx, driver, tenantName, neo4jentity.IssueEntity{CreatedAt: secInFuture10})
