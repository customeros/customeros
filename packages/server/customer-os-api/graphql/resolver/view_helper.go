...
func DefaultTableViewDefinitionCustomers(span opentracing.Span) (postgresEntity.TableViewDefinition, error) {
	...
	return postgresEntity.TableViewDefinition{
		...
		Icon:           "CheckHeart",
		Filters:        ``,
		DefaultFilters: fmt.Sprintf(`{"AND":[{"filter":{"includeEmpty":false,"operation":"IN","property":"ORGANIZATIONS_RELATIONSHIP","value":["%s"],"active":true}}]}`, neo4jenum.OrganizationRelationshipCustomer.String()),
		Sorting:        `{"id": "ORGANIZATIONS_UPDATED_DATE", "desc": true}`,
		IsPreset:       true,
		IsShared:       false,
	}, nil
...
func DefaultTableViewDefinitionTargets(span opentracing.Span) (postgresEntity.TableViewDefinition, error) {
	...
	return postgresEntity.TableViewDefinition{
		...
		Icon:           "Target05",
		Filters:        ``,
		DefaultFilters: fmt.Sprintf(`{"AND":[{"filter":{"includeEmpty":false,"operation":"IN","property":"ORGANIZATIONS_STAGE","value":["%s"],"active":true}},{"filter":{"includeEmpty":false,"operation":"IN","property":"ORGANIZATIONS_RELATIONSHIP","value":["%s"],"active":true}}]}`, neo4jenum.Target.String(), neo4jenum.OrganizationRelationshipProspect.String()),
		Sorting:        `{"id": "ORGANIZATIONS_UPDATED_DATE", "desc": true}`,
		IsPreset:       true,
		IsShared:       false,
	}, nil
	...
	case model.TableIDTypeCustomers.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 13, ColumnType: model.ColumnViewTypeOrganizationsPrimaryDomains.String(), Width: 100, Visible: true, Name: "", Filter: ""},
	...
	case model.TableIDTypeOrganizations.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 2, ColumnType: model.ColumnViewTypeOrganizationsName.String(), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 3, ColumnType: model.ColumnViewTypeOrganizationsWebsite.String(), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 28, ColumnType: model.ColumnViewTypeOrganizationsPrimaryDomains.String(), Width: 100, Visible: true, Name: "", Filter: ""},
	...
	case model.TableIDTypeTargets.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 2, ColumnType: model.ColumnViewTypeOrganizationsName.String(), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 3, ColumnType: model.ColumnViewTypeOrganizationsWebsite.String(), Width: 100, Visible: true, Name: "", Filter: ""},
				{ColumnId: 20, ColumnType: model.ColumnViewTypeOrganizationsPrimaryDomains.String(), Width: 100, Visible: true, Name: "", Filter: ""},
	...
	case model.TableIDTypeContacts.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 26, ColumnType: model.ColumnViewTypeContactsCreatedAt.String(), Width: 100, Visible: false, Name: "", Filter: ""},
			},
		}
	...
	case model.TableIDTypeFlowActions.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 6, ColumnType: model.ColumnViewTypeFlowOnHoldCount.String(), Width: 100, Visible: true, Name: "Blocked", Filter: ""},
	...
	case model.TableIDTypeFlowContacts.String():
		return postgresEntity.Columns{
			Columns: []postgresEntity.ColumnView{
				...
				{ColumnId: 5, ColumnType: model.ColumnViewTypeContactsEmails.String(), Width: 100, Visible: true, Name: "Emails", Filter: ""},
				{ColumnId: 6, ColumnType: model.ColumnViewTypeContactsPhoneNumbers.String(), Width: 100, Visible: true, Name: "Phone numbers", Filter: ""},
				{ColumnId: 7, ColumnType: model.ColumnViewTypeContactsLinkedin.String(), Width: 100, Visible: true, Name: "LinkedIn", Filter: ""},
				{ColumnId: 8, ColumnType: model.ColumnViewTypeContactsJobTitle.String(), Width: 100, Visible: true, Name: "Job title", Filter: ""},
				{ColumnId: 9, ColumnType: model.ColumnViewTypeContactsTimeInCurrentRole.String(), Width: 100, Visible: true, Name: "Time In Current Role", Filter: ""},
