...
func EnrichPerson(services *cosapi_services.Services) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if betterContactResponseBody == nil {
			...
			response.ResultURL = services.Cfg.CommonServices.InternalServices.CustomerOsApiUrl + enrichPersonAcceptedUrl + "/" + dbRecord.ID.String()
		} else {
...
func EnrichPersonCallback(services *cosapi_services.Services) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if betterContactResponseBody == nil {
			...
			response.ResultURL = services.Cfg.CommonServices.InternalServices.CustomerOsApiUrl + enrichPersonAcceptedUrl + "/" + tempId
		} else {
			response.IsComplete = true
