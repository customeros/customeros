...
func VerifyTracker(s *cosapi_services.Services) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if !exists || domain == "" {
			handlers.SendError(c, span, http.StatusBadRequest, enum.ErrBadRequest.WithMessage("must provide domain"))
			return
		}
