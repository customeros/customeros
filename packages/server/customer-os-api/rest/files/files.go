...
func UploadFile(s *cosapi_services.Services, filePath string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusOK, mapper.MapFileEntityToDTO(fileEntity, s.Cfg.CommonServices.InternalServices.CustomerOsApiUrl+filePath))
	}
}
...
func GetFileByID(s *cosapi_services.Services, filePath string) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(200, mapper.MapFileEntityToDTO(byId, s.Cfg.CommonServices.InternalServices.CustomerOsApiUrl+filePath))
	}
}
