...
func RedirectToPayInvoice(services *cosapi_services.Services) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if generateNewLink {
			...
			err = callIntegrationAppWithApiRequestForNewPaymentLink(innerCtx, services.Cfg.CommonServices.ExternalServices.IntegrationAppConfig.WorkspaceKey,
				services.Cfg.CommonServices.ExternalServices.IntegrationAppConfig.WorkspaceSecret, tenant,
				services.Cfg.CommonServices.ExternalServices.IntegrationAppConfig.ApiTriggerUrlCreatePaymentLinks, primaryStripeCustomerId, invoice)
			if err != nil {
