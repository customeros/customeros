...
func CallbackSlack(s *cosapi_services.Services) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		requestData.Set("client_id", s.Cfg.CommonServices.ExternalServices.SlackConfig.ClientID)
		requestData.Set("client_secret", s.Cfg.CommonServices.ExternalServices.SlackConfig.ClientSecret)
