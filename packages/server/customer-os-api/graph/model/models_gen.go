...
func (e TableViewType) IsValid() bool {
	switch e {
	case TableViewTypeOrganizations, TableViewTypeInvoices, TableViewTypeRenewals, TableViewTypeContacts:
		return true
	}
	return false
}
