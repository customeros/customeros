...
func TestQueryResolver_GetData_Search_Contact_Linked_To_Organization_By_Email_1(t *testing.T) {
	defer tearDownTestCase()(t)
	neo4jt.CreateTenant(driver, tenantName)
...
func TestQueryResolver_GetData_Search_Contact_Linked_To_Organization_By_Email_2(t *testing.T) {
	defer tearDownTestCase()(t)
	neo4jt.CreateTenant(driver, tenantName)
