...
func TestQueryResolver_UIOrganizationsSearch_FilterByTags(t *testing.T) {
	...
	//TODO NotContains doesn't work
	//assertSearch(t, searchBy, "D", commonModel.ComparisonOperatorNotContains, 3, 2)
	//assertSearch(t, searchBy, "B", commonModel.ComparisonOperatorNotContains, 3, 1)
	//assertSearch(t, searchBy, "A", commonModel.ComparisonOperatorNotContains, 3, 0)
}
