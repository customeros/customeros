...
const docTemplate = `{
        ...
        "/customerbase/v1/organizations/{id}/links/{externalSystem}/primary": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "External system name, supported values (stripe, hubspot, close)",
                        "name": "externalSystem",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Request payload to set primary external system ID",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/customerbase.SetPrimaryExternalSystemIdResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "customerbase.SetPrimaryExternalSystemIdResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "description": "Message provides additional information regarding the API.",
                    "type": "string",
                    "example": "Primary ID set successfully"
                },
                "organizationId": {
                    "description": "The organization ID for which the primary ID was set.",
                    "type": "string",
                    "example": "org-789"
                },
                "primaryExternalId": {
                    "description": "The primary external ID that was set.",
                    "type": "string",
                    "example": "stripe-1234"
                },
                "status": {
