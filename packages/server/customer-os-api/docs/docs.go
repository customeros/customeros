    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/billing.InvoicesResponse"
                        }
                    },
                    "206": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/customerbase.ContactRecord"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/customerbase.SingleContactResponse"
                        }
                    },
                    "201": {
                        "description": "Successfully processed CSV file",
                        "schema": {
                            "$ref": "#/definitions/customerbase.ContactsResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/customerbase.BulkResponse"
                        }
                    },
                    "207": {
                        "description": "Contacts created with some failures",
                        "schema": {
                            "$ref": "#/definitions/customerbase.BulkResponseMultipleErrors"
                        }
                    },
                    "400": {
                        "description": "Invalid request data",
        ...
        "/customerbase/v1/contacts/import": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "CSV file with contact data (required headers: email, linkedin_url)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/customerbase.SetPrimaryExternalSystemIdRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/customerbase.ExternalSystemResponse"
                        }
                    },
                    "400": {
        ...
        "/domains": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved domain list",
                        "schema": {
                    ...
                    "500": {
                        "description": "Internal server error - Unable to retrieve domains",
                        "schema": {
                            "$ref": "#/definitions/rest.ErrorResponse"
                        }
                    }
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Domain registered and configured successfully",
                        "schema": {
                    ...
                    "406": {
                        "description": "Not Acceptable - Domain TLD not supported or premium domain",
                        "schema": {
                            "$ref": "#/definitions/rest.ErrorResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Internal server error - Configuration failed or service unavailable",
                        "schema": {
                            "$ref": "#/definitions/rest.ErrorResponse"
                        }
                    }
        ...
        "/domains/configure": {
            "post": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Not Found - Domain not found or not owned by tenant",
                        "schema": {
                            "$ref": "#/definitions/rest.ErrorResponse"
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/restoutreach.EmailTrackingRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/restoutreach.EmailTrackingResponse"
                        }
                    },
                    "400": {
        ...
        "/verify/v1/ip": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "IP intelligence data retrieved successfully",
                        "schema": {
    ...
    "definitions": {
        ...
        "billing.InvoicesResponse": {
            ...
            "properties": {
                "invoices": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/billing.InvoiceRecord"
                    }
                },
                "requestId": {
                    "type": "string",
        ...
        "customerbase.BulkResponse": {
            ...
            "properties": {
                "details": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/customerbase.BulkErrorDetails"
                        }
                    ]
                },
                "requestId": {
                ...
                "summary": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/customerbase.BulkSummary"
                        }
                    ]
                }
            }
        ...
        "customerbase.ExternalSystemResponse": {
            ...
            "properties": {
                "organization": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/customerbase.ExternalSystemRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "customerbase.OrganizationResponse": {
            ...
            "properties": {
                "organization": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/customerbase.OrganizationRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "restmailstack.ConfigureDomainRequest": {
            ...
            "properties": {
                ...
                "website": {
                    "description": "Website URL for domain configuration\nrequired: true\nformat: uri\nexample: https://www.example.com",
                    "type": "string"
                }
            }
        },
        "restmailstack.DomainRecord": {
            ...
            "properties": {
                ...
                "nameservers": {
                    "description": "List of assigned nameservers\nrequired: true\nminItems: 2\nexample: [\"ns1.example.com\",\"ns2.example.com\"]",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "restmailstack.DomainResponse": {
            ...
            "properties": {
                "domain": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/restmailstack.DomainRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "restmailstack.MailboxResponse": {
            ...
            "properties": {
                "mailbox": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/restmailstack.MailboxRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "restoutreach.EmailTrackingResponse": {
            ...
            "properties": {
                ...
                "trackedLinks": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/restoutreach.TrackedLink"
                    }
                },
                "trackingId": {
        ...
        "restverify.EmailVerificationResponse": {
            ...
            "properties": {
                "email": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/restverify.EmailVerificationRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "restverify.IpIntelligenceGeolocation": {
            ...
            "properties": {
                ...
                "isEuropeanUnion": {
                    "description": "Indicates if country is in the European Union\nrequired: true",
                    "type": "boolean",
                    "example": true
                }
            }
        ...
        "restverify.IpIntelligenceNetwork": {
            ...
            "properties": {
                ...
                "route": {
                    "description": "Network route (CIDR notation)\nrequired: true\npattern: ^(\\d{1,3}\\.){3}\\d{1,3}/\\d{1,2}$",
                    "type": "string",
        ...
        "restverify.IpIntelligenceRecord": {
        ...
        "restverify.IpIntelligenceResponse": {
            ...
            "properties": {
                "ip": {
                    "description": "IP intelligence details\nrequired: true",
                    "allOf": [
                        {
                            "$ref": "#/definitions/restverify.IpIntelligenceRecord"
                        }
                    ]
                },
                "requestId": {
        ...
        "restverify.IpIntelligenceThreats": {
            ...
            "properties": {
                "isCloudRelay": {
                    "description": "Indicates if IP is a cloud relay\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isDatacenter": {
                    "description": "Indicates if IP belongs to a datacenter\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isMobile": {
                    "description": "Indicates if IP belongs to a mobile network\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isProxy": {
                    "description": "Indicates if IP is a proxy\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isTor": {
                    "description": "Indicates if IP is a TOR exit node\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isUnallocated": {
                    "description": "Indicates if IP is unallocated\nrequired: true",
                    "type": "boolean",
                    "example": false
                },
                "isVpn": {
                    "description": "Indicates if IP is a VPN\nrequired: true",
                    "type": "boolean",
                    "example": false
                }
            }
