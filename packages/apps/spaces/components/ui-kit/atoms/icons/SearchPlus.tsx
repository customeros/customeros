...
const SvgSearchPlus = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d='M20 20.75a.74.74 0 0 1-.53-.22l-4.13-4.13a.75.75 0 0 1 1.06-1.06l4.13 4.13a.75.75 0 0 1 0 1.06.74.74 0 0 1-.53.22zM10.75 14a.76.76 0 0 1-.75-.75v-5a.75.75 0 1 1 1.5 0v5a.76.76 0 0 1-.75.75z' />
    <path d='M13.25 11.5h-5a.75.75 0 0 1-.75-.75.75.75 0 0 1 .75-.75h5a.75.75 0 0 1 .75.75.75.75 0 0 1-.75.75z' />
  </svg>
);
