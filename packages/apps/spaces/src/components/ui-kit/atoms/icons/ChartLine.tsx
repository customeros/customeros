...
const SvgChartLine = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <g fill='currentColor'>
      ...
      <path d='M19.5 20.25h-15a.75.75 0 1 1 0-1.5h15a.75.75 0 1 1 0 1.5ZM14 14.75a.74.74 0 0 1-.53-.22L11 12.06l-2.47 2.47a.75.75 0 0 1-1.06-1.06l3-3a.75.75 0 0 1 1.06 0L14 12.94l3.47-3.47a.75.75 0 0 1 1.06 1.06l-4 4a.74.74 0 0 1-.53.22Z' />
