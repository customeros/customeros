...
>(
  ...
  >({
    ...
    mutationFn: (variables?: BulkUpdateOpportunityRenewalMutationVariables) =>
      fetcher<
        BulkUpdateOpportunityRenewalMutation,
        BulkUpdateOpportunityRenewalMutationVariables
      >(client, BulkUpdateOpportunityRenewalDocument, variables, headers)(),
    ...options,
  });
};

useBulkUpdateOpportunityRenewalMutation.getKey = () => [
  'bulkUpdateOpportunityRenewal',
];

useBulkUpdateOpportunityRenewalMutation.fetcher = (
  client: GraphQLClient,
  variables: BulkUpdateOpportunityRenewalMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<
    BulkUpdateOpportunityRenewalMutation,
