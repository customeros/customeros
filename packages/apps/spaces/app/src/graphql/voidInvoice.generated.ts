...
export const useVoidInvoiceMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  ...
  >({
    ...
    mutationFn: (variables?: VoidInvoiceMutationVariables) =>
      fetcher<VoidInvoiceMutation, VoidInvoiceMutationVariables>(
        client,
        VoidInvoiceDocument,
        variables,
        headers,
...
useVoidInvoiceMutation.fetcher = (
  client: GraphQLClient,
  variables: VoidInvoiceMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<VoidInvoiceMutation, VoidInvoiceMutationVariables>(
    client,
