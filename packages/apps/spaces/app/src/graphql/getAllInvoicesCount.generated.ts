...
export type GetAllInvoicesCountQueryVariables = Types.Exact<{
  [key: string]: never;
}>;

export type GetAllInvoicesCountQuery = {
  __typename?: 'Query';
  invoices: { __typename?: 'InvoicesPage'; totalElements: any };
};
...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetAllInvoicesCountQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
      GetAllInvoicesCountQuery,
      TError,
      TData
    >['queryKey'];
  },
  ...
  return useQuery<GetAllInvoicesCountQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ['getAllInvoicesCount']
        : ['getAllInvoicesCount', variables],
    queryFn: fetcher<
      GetAllInvoicesCountQuery,
      GetAllInvoicesCountQueryVariables
    >(client, GetAllInvoicesCountDocument, variables, headers),
    ...options,
  });
};
...
useGetAllInvoicesCountQuery.getKey = (
  variables?: GetAllInvoicesCountQueryVariables,
) =>
  variables === undefined
    ? ['getAllInvoicesCount']
...
>(
  ...
  variables: GetAllInvoicesCountQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetAllInvoicesCountQuery, TError, TData>,
    'queryKey'
  > & {
      ...
      return {
        queryKey:
          optionsQueryKey ?? variables === undefined
            ? ['getAllInvoicesCount.infinite']
            : ['getAllInvoicesCount.infinite', variables],
        queryFn: (metaData) =>
          fetcher<GetAllInvoicesCountQuery, GetAllInvoicesCountQueryVariables>(
            client,
            GetAllInvoicesCountDocument,
...
useInfiniteGetAllInvoicesCountQuery.getKey = (
  variables?: GetAllInvoicesCountQueryVariables,
) =>
  variables === undefined
    ? ['getAllInvoicesCount.infinite']
...
useGetAllInvoicesCountQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetAllInvoicesCountQueryVariables,
  headers?: RequestInit['headers'],
) =>
...
useInfiniteGetAllInvoicesCountQuery.mutateCacheEntry =
  ...
  (
    mutator: (
      cacheEntry: InfiniteData<GetAllInvoicesCountQuery>,
    ) => InfiniteData<GetAllInvoicesCountQuery>,
  ) => {
    const cacheKey = useInfiniteGetAllInvoicesCountQuery.getKey(variables);
    const previousEntries =
      queryClient.getQueryData<InfiniteData<GetAllInvoicesCountQuery>>(
        cacheKey,
      );
    if (previousEntries) {
      queryClient.setQueryData<InfiniteData<GetAllInvoicesCountQuery>>(
        cacheKey,
        mutator,
      );
    }
