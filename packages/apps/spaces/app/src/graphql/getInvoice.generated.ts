...
export type GetInvoiceQuery = { __typename?: 'Query', invoice: { __typename?: 'Invoice', id: string, createdAt: any, status?: Types.InvoiceStatus | null, number: string, periodStartDate: any, periodEndDate: any, dueDate: any, amount: number, vat: number, totalAmount: number, currency: string, repositoryFileId: string, invoiceLines: Array<{ __typename?: 'InvoiceLine', id: string, createdAt: any, quantity: number, amount: number, vat: number, totalAmount: number, price: number, name: string }> } };
