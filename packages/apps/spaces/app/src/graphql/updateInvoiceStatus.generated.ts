...
>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateInvoiceStatusMutationVariables) =>
      fetcher<
        UpdateInvoiceStatusMutation,
        UpdateInvoiceStatusMutationVariables
      >(client, UpdateInvoiceStatusDocument, variables, headers)(),
    ...options,
  });
};
...
useUpdateInvoiceStatusMutation.fetcher = (
  client: GraphQLClient,
  variables: UpdateInvoiceStatusMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<UpdateInvoiceStatusMutation, UpdateInvoiceStatusMutationVariables>(
    client,
