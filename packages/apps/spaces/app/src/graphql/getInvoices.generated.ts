...
export type GetInvoicesQuery = { __typename?: 'Query', invoices: { __typename?: 'InvoicesPage', totalPages: number, totalElements: any, content: Array<{ __typename?: 'Invoice', id: string, number: string, dueDate: any, periodStartDate: any, periodEndDate: any, totalAmount: number, currency: string, dryRun: boolean, status?: Types.InvoiceStatus | null, createdAt: any, invoiceLines: Array<{ __typename?: 'InvoiceLine', id: string, name: string, price: number, quantity: number, amount: number, vat: number, totalAmount: number }> }> } };
