...
export const usePayInvoiceMutation = <TError = unknown, TContext = unknown>(
  client: GraphQLClient,
  ...
  >({
    ...
    mutationFn: (variables?: PayInvoiceMutationVariables) =>
      fetcher<PayInvoiceMutation, PayInvoiceMutationVariables>(
        client,
        PayInvoiceDocument,
        variables,
        headers,
...
usePayInvoiceMutation.fetcher = (
  client: GraphQLClient,
  variables: PayInvoiceMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<PayInvoiceMutation, PayInvoiceMutationVariables>(
    client,
