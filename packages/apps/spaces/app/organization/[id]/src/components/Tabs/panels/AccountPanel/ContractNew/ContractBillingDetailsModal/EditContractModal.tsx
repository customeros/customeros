...
import { ModalWithInvoicePreview } from '@organization/src/components/Tabs/panels/AccountPanel/ContractNew/ContractBillingDetailsModal/ModalWithInvoicePreview';
