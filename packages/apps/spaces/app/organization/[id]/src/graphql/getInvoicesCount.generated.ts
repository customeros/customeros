...
>(
  ...
  options?: Omit<
    UseQueryOptions<GetInvoicesCountQuery, TError, TData>,
    'queryKey'
  > & {
  ...
  return useQuery<GetInvoicesCountQuery, TError, TData>({
    queryKey:
      variables === undefined
        ? ['getInvoicesCount']
        : ['getInvoicesCount', variables],
    queryFn: fetcher<GetInvoicesCountQuery, GetInvoicesCountQueryVariables>(
      client,
      GetInvoicesCountDocument,
      variables,
      headers,
    ),
    ...options,
...
useGetInvoicesCountQuery.getKey = (
  variables?: GetInvoicesCountQueryVariables,
) =>
  variables === undefined
    ? ['getInvoicesCount']
...
>(
  ...
  variables: GetInvoicesCountQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<GetInvoicesCountQuery, TError, TData>,
    'queryKey'
  > & {
      ...
      return {
        queryKey:
          optionsQueryKey ?? variables === undefined
            ? ['getInvoicesCount.infinite']
            : ['getInvoicesCount.infinite', variables],
        queryFn: (metaData) =>
          fetcher<GetInvoicesCountQuery, GetInvoicesCountQueryVariables>(
            client,
            GetInvoicesCountDocument,
...
useInfiniteGetInvoicesCountQuery.getKey = (
  variables?: GetInvoicesCountQueryVariables,
) =>
  variables === undefined
    ? ['getInvoicesCount.infinite']
...
useGetInvoicesCountQuery.fetcher = (
  client: GraphQLClient,
  variables?: GetInvoicesCountQueryVariables,
  headers?: RequestInit['headers'],
) =>
...
useInfiniteGetInvoicesCountQuery.mutateCacheEntry =
  ...
  (
    mutator: (
      cacheEntry: InfiniteData<GetInvoicesCountQuery>,
    ) => InfiniteData<GetInvoicesCountQuery>,
  ) => {
    ...
    if (previousEntries) {
      queryClient.setQueryData<InfiniteData<GetInvoicesCountQuery>>(
        cacheKey,
        mutator,
      );
    }
