      ...
      <Menu>
        {({ open }) => (
          <div className="relative w-full">
            <div className="">
              <Menu.Button className="text-md inline-flex cursor-pointer items-center gap-1.5 whitespace-nowrap rounded-md border-2 bg-cos-green-200/50 px-3 py-2 font-medium hover:bg-cos-green-200/75 dark:border-cos-green-200/20 dark:bg-cos-green-200/10 dark:hover:border-cos-green-200/50">
                On this page
                <svg
            ...
            <Menu.Items
              dir="ltr"
              className="cos-scrollbar absolute top-full z-10 mt-3 max-h-[45vh] w-full overflow-y-auto rounded-md border-2 border-primary bg-default py-1.5 shadow-md dark:border-cos-green-200/20 dark:bg-default"
            >
                  ...
                  <li key={heading.slug} className="w-full">
                    <Menu.Item>
                      {({ active }) => (
                        <a
                          className={clsx(
                            "text-md line-clamp-1 block w-full py-2 text-cos-green-800 transition-colors hover:bg-cos-green-300/20 hover:text-cos-green-400 dark:text-cos-green-200 dark:hover:bg-cos-green-300/10 dark:hover:text-cos-green-50",
                            isLtr && (heading.depth === 2 ? "pl-3" : "pl-8"),
                            isRtl && (heading.depth === 2 ? "pr-3" : "pr-8"),
                            {
                              "bg-cos-green-300/20 text-cos-green-400 underline dark:bg-cos-green-300/10 dark:text-cos-green-100":
                                active,
                              "bg-cos-green-300/30 font-medium text-cos-green-700 underline dark:bg-cos-green-300/20 dark:text-cos-green-100":
                                heading.isVisible,
                            },
                          )}
                          href={`#${heading.slug}`}
