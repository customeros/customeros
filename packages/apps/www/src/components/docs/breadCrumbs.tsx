...
export default function BreadCrumbs() {
  ...
  return (
    <div className="mb-4 flex items-center gap-2 px-4 text-sm">
      <a
        href="/"
        className="rounded-lg border bg-cos-green-200/50 p-1 hover:bg-cos-green-200/75 hover:no-underline dark:border-cos-green-200/20 dark:bg-cos-green-200/10 dark:hover:border-cos-green-200/50"
      >
