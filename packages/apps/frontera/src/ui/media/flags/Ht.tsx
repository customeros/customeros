...
export const Ht = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    <g stroke='#000' fill='#f1b517' strokeWidth='.2'>
      ...
      <g transform='translate(-80)scale(1.6)'>
        ...
        <g id='ht-d'>
          ...
          <ellipse rx='1.3' ry='1.2' cx='227.7' cy='168.6' />
          <path
            fillRule='evenodd'
            strokeLinecap='round'
          ...
          <circle r='.7' cx='232.5' cy='177.1' />
          <circle r='.7' cx='230.6' cy='175.7' />
          <circle r='.7' cx='228.1' cy='176.6' />
          <circle r='.7' cx='224.2' cy='177.4' />
          <circle r='.7' cx='222.5' cy='177.6' />
          <circle r='.7' cx='220.8' cy='177.6' />
          <circle r='.7' cx='219.2' cy='177.6' />
          <circle r='.7' cx='220' cy='176.3' />
          <circle r='.7' cx='221.6' cy='176.4' />
          <circle r='.7' cx='223.1' cy='176.2' />
          <circle r='.7' cy='175' cx='222.4' />
          <circle r='.7' cx='220.8' cy='174.9' />
          <path
            fillRule='evenodd'
