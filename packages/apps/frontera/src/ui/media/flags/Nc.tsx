...
export const Nc = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    />
    <ellipse cx='240' rx='17.6' ry='25.6' cy='312.5' fill='#000001' />
    <ellipse cx='240' rx='21.3' ry='13.5' cy='243.7' fill='#000001' />
    <circle cx='240' r='21.3' cy='181.3' fill='#000001' />
    <path
      fill='#000001'
