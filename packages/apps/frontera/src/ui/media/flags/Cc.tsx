...
export const Cc = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    <circle cy='240' r='54.9' cx='340.8' fill='green' />
    <circle r='69.8' cx='109.8' cy='173.3' fill='#ffe000' />
    <path
      fill='#802000'
      stroke='#7b3100'
      strokeWidth='1.5'
    ...
    <g fill='#ffe000' transform='translate(0 80)scale(.0635)'>
      <use x='7560' y='4200' width='100%' height='100%' xlinkHref='#cc-a' />
      <use x='6300' y='2205' width='100%' height='100%' xlinkHref='#cc-a' />
      <use y='840' x='7560' width='100%' height='100%' xlinkHref='#cc-a' />
      <use x='8680' y='1869' width='100%' height='100%' xlinkHref='#cc-a' />
      <use x='8064' y='2730' width='100%' height='100%' xlinkHref='#cc-b' />
    </g>
  </svg>
);
