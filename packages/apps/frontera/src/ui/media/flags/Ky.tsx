...
export const Ky = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    >
      <use width='100%' height='100%' xlinkHref='#ky-a' />
      <use width='100%' height='100%' xlinkHref='#ky-b' />
      <use width='100%' height='100%' xlinkHref='#ky-c' />
      <use width='100%' height='100%' xlinkHref='#ky-d' />
      <use width='100%' height='100%' xlinkHref='#ky-e' />
      <use width='100%' height='100%' xlinkHref='#ky-f' />
      <use width='100%' height='100%' xlinkHref='#ky-g' />
    </g>
    <g
      stroke='#000'
      strokeWidth='1.4'
    ...
    <g strokeWidth='1.4' transform='translate(-306.8 -21.2)scale(.87136)'>
      ...
      <use x='90.1' width='100%' height='100%' xlinkHref='#ky-h' />
      <use x='45' y='52.2' width='100%' height='100%' xlinkHref='#ky-h' />
      <path
        fill='none'
        stroke='#000'
        d='M989.7 233v93.4c0 81-38.3 108.8-89.6 130.8-51.3-22-90-49.8-90-130.8v-93.5h179.6z'
