...
export const Me = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    />
    <ellipse cy='226' rx='1.5' ry='1.4' cx='312.6' fill='#b96b29' />
    <path
      fill='#b96b29'
    ...
    />
    <circle r='.7' cx='320' cy='132.8' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    />
    <ellipse cx='320' rx='2.8' ry='2.7' cy='122.3' fill='#b96b29' />
    <ellipse cx='320' rx='2.7' ry='2.6' cy='115.8' fill='#b96b29' />
    <ellipse cx='320' rx='2.6' ry='2.5' cy='109.7' fill='#b96b29' />
    <ellipse cx='320' rx='1.5' ry='1.4' cy='121.8' fill='#d4af3a' />
    <circle r='1.4' cx='320' cy='115.4' fill='#d4af3a' />
    <ellipse cx='320' rx='1.3' ry='1.2' cy='109.2' fill='#d4af3a' />
    <path
      fill='#b96b29'
    ...
    />
    <ellipse cx='274' rx='1.8' ry='1.6' cy='158.6' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    <ellipse rx='3.2' ry='3.1' cx='309.2' cy='142.1' fill='#b96b29' />
    <circle r='1.9' cx='309.2' cy='141.4' fill='#d4af3a' />
    <path
      fill='#d4af3a'
      d='M302.4 131.4c.9.3 2 .2 2 .2s.3-1.4-.5-2.1l-2-1.7-.5-.6-.1 2c0 .8.3 1.9 1.2 2.2z'
    />
    <circle r='.6' cy='133' cx='304.2' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    />
    <ellipse rx='.7' ry='.5' cx='288.6' cy='135.1' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    />
    <circle r='1.3' cx='285.1' cy='123.2' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    />
    <ellipse rx='2.7' ry='2.6' cx='300.7' cy='121.9' fill='#b96b29' />
    <path
      fill='#b96b29'
      d='M305.3 112.7c-1-.7-2.6-.4-3.5.6-.9 1.1-.7 2.6.4 3.3 1 .7 2.6.4 3.5-.6.8-1.1.7-2.6-.4-3.3'
    />
    <ellipse rx='1.6' ry='1.5' cx='300.6' cy='121.5' fill='#d4af3a' />
    <path
      fill='#d4af3a'
    ...
    />
    <circle r='2.3' cx='408.9' cy='311.2' fill='#b96b29' />
    <circle r='2.4' cx='415.5' cy='312.8' fill='#b96b29' />
    <circle r='2.4' cx='434.6' cy='316.9' fill='#b96b29' />
    <circle r='2.4' cx='422.1' cy='314.4' fill='#b96b29' />
    <circle r='2.4' cx='423.8' cy='308.6' fill='#b96b29' />
    <circle r='2.4' cx='425.5' cy='302.9' fill='#b96b29' />
    <circle r='1.2' cx='409.1' cy='310.9' fill='#d4af3a' />
    <circle r='1.2' cx='415.6' cy='312.6' fill='#d4af3a' />
    <circle r='1.2' cx='434.8' cy='316.6' fill='#d4af3a' />
    <circle r='1.2' cx='422.2' cy='314.1' fill='#d4af3a' />
    <circle r='1.2' cx='424' cy='308.4' fill='#d4af3a' />
    <circle r='1.2' cx='425.7' cy='302.6' fill='#d4af3a' />
    <path
      fill='#d4af3a'
