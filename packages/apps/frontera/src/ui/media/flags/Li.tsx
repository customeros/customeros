...
export const Li = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    >
      <g id='li-a'>
        ...
        <circle r='4.9' cy='113' cx='212.8' />
        <circle r='4.9' cx='201.7' cy='110.3' />
        <circle r='4.9' cx='190.4' cy='107.5' />
        <circle r='4.9' cx='179.1' cy='105.6' />
        <circle r='4.9' cx='167.8' cy='104.5' />
        <circle r='4.9' cx='156.8' cy='105.1' />
        <circle r='4.9' cx='146.2' cy='108.7' />
        <circle r='4.9' cx='137.3' cy='115.3' />
        <circle r='4.9' cx='131' cy='124.4' />
        <circle r='4.9' cx='127.9' cy='135.2' />
        <circle r='4.9' cx='128' cy='146.3' />
        <circle r='4.9' cx='130.2' cy='157.2' />
      ...
      <g strokeWidth='1.5'>
        ...
        />
        <circle r='3.5' cx='222' cy='114.4' />
        <circle r='3.7' cx='222' cy='122' />
        <circle r='4.1' cx='222' cy='130.2' />
        <circle r='4.7' cx='222' cy='139.3' />
        <circle r='5.1' cx='222' cy='149.4' />
        <path
          stroke='none'
          fill='#000001'
