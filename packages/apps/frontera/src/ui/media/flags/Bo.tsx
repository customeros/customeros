...
export const Bo = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    />
    <path stroke='#000' fill='#005000' strokeWidth='.1' d='M306 221.7h.8z' />
    <path
      fill='#fff'
      stroke='#000'
      strokeWidth='.1'
    ...
    />
    <path stroke='#000' fill='#005000' strokeWidth='.1' d='M334 221.7h-.8z' />
    <path
      fill='#fff'
      stroke='#000'
      strokeWidth='.1'
    ...
    <circle r='.6' cy='237.4' cx='-316.9' transform='scale(-1 1)' />
