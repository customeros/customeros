...
export const Mn = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    <circle r='40' cx='106.7' cy='181.8' />
    <circle r='43.6' cx='106.7' cy='163.6' fill='#da2032' />
    <circle r='29.1' cx='106.7' cy='170.9' />
    ...
    <circle r='36.4' cx='106.7' cy='316.4' />
    <g fill='#da2032' transform='translate(-38.8 32.7)scale(.72727)'>
      <circle r='10' cx='200' cy='363.5' />
      <circle r='10' cx='200' cy='416.5' />
