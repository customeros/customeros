...
export const Eg = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    <g fill='#fff' stroke='#c09300' transform='translate(-40)scale(.8)'>
      ...
      />
      <g id='eg-b' fill='none' strokeWidth='1.3' strokeLinejoin='round'>
        <path
          fill='#fff'
          strokeWidth='1.2'
      ...
      <g strokeWidth='1.3'>
        ...
        />
        <circle r='1.2' cx='448.8' cy='210.7' stroke='none' />
      </g>
    </g>
  </svg>
);
