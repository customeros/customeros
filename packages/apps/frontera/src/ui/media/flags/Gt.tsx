...
export const Gt = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    <defs>
      ...
      <linearGradient
        ...
        gradientUnits='userSpaceOnUse'
      >
        <stop offset='.2' stopOpacity='0' stopColor='#b07e09' />
        <stop offset='1' stopColor='#b07e09' />
      </linearGradient>
      <linearGradient
        id='gt-i'
    ...
    <g transform='matrix(.81133 0 0 .8264 -69.4 -8)'>
      <g stroke='#24420e'>
        ...
        <g fill='#ba1f3e' stroke='#511124' strokeWidth='.2'>
          <circle r='1.1' cx='396.8' cy='251.3' />
          <circle r='1.1' cx='405.2' cy='245.1' />
          <circle r='1.1' cx='401.6' cy='241.7' />
          <circle r='1.3' cx='392.5' cy='313.1' />
          <circle r='1.3' cx='395' cy='297.1' />
          <circle r='1.3' cx='408.2' cy='334.5' />
          <circle r='1.3' cx='402.4' cy='336.4' />
          <circle r='1.3' cx='446.7' cy='367.6' />
          <circle r='1.3' cx='449.6' cy='374.7' />
        </g>
      </g>
      <g stroke='#24420e'>
        <path
        ...
        <g fill='#ba1f3e' stroke='#511124' strokeWidth='.2'>
          <circle r='1.1' cx='564.6' cy='254.9' />
          <circle r='1.1' cx='568.4' cy='266.8' />
          <circle r='1.3' cx='569.8' cy='304.3' />
          <circle r='1.3' cx='564.6' cy='297.3' />
          <circle r='1.3' cx='549.9' cy='337.2' />
          <circle r='1.3' cx='556.2' cy='339.9' />
          <circle r='1.3' cx='513.8' cy='372.3' />
          <circle r='1.3' cx='506.8' cy='377.3' />
          <circle r='1.1' cx='557.1' cy='249.3' />
        </g>
      </g>
      <g id='gt-b' fill='#8c959d' stroke='#485654' strokeWidth='.1'>
        ...
        />
        <circle r='.6' cx='438.2' cy='328.1' fill='none' strokeWidth='.2' />
        <circle r='.6' cx='434.4' cy='331.9' fill='none' strokeWidth='.2' />
        <path
          stroke='none'
          fill='#485654'
      ...
      />
      <circle r='.8' cx='477.7' cy='215.4' stroke='#000' strokeWidth='.1' />
      <ellipse rx='.3' ry='.4' cx='477.9' cy='215.3' fill='url(#gt-n)' />
      <g fill='#34541f'>
