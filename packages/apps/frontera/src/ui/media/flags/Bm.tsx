...
export const Bm = ({ className, ...props }: IconProps) => (
  <svg
    fill='none'
    viewBox='0 0 640 480'
    {...props}
  ...
  >
    ...
    <ellipse rx='.8' ry='1.1' cx='479.4' cy='152.8' fill='#784421' />
    <ellipse rx='.5' ry='.7' cx='479.4' cy='152.8' />
    ...
    <ellipse rx='.8' ry='1.1' cx='467.7' cy='152.8' fill='#784421' />
    <ellipse rx='.5' ry='.7' cx='467.7' cy='152.8' />
    <path
      fill='none'
      stroke='#000'
      strokeWidth='1.2'
