...
>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateBankAccountMutationVariables) =>
      fetcher<CreateBankAccountMutation, CreateBankAccountMutationVariables>(
        client,
...
useCreateBankAccountMutation.fetcher = (
  client: GraphQLClient,
  variables: CreateBankAccountMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<CreateBankAccountMutation, CreateBankAccountMutationVariables>(
    client,
