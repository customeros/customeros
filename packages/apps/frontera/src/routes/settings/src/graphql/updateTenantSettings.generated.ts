...
>(
  ...
  >({
    ...
    mutationFn: (variables?: UpdateTenantSettingsMutationVariables) =>
      fetcher<
        UpdateTenantSettingsMutation,
        UpdateTenantSettingsMutationVariables
      >(client, UpdateTenantSettingsDocument, variables, headers)(),
    ...options,
  });
};
...
useUpdateTenantSettingsMutation.fetcher = (
  client: GraphQLClient,
  variables: UpdateTenantSettingsMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<UpdateTenantSettingsMutation, UpdateTenantSettingsMutationVariables>(
    client,
