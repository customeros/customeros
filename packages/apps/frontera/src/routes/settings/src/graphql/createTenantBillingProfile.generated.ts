...
export type CreateBillingProfileMutation = {
  __typename?: 'Mutation';
  tenant_AddBillingProfile: { __typename?: 'TenantBillingProfile'; id: string };
};
...
>(
  ...
  >({
    ...
    mutationFn: (variables?: CreateBillingProfileMutationVariables) =>
      fetcher<
        CreateBillingProfileMutation,
        CreateBillingProfileMutationVariables
      >(client, CreateBillingProfileDocument, variables, headers)(),
    ...options,
  });
};
...
useCreateBillingProfileMutation.fetcher = (
  client: GraphQLClient,
  variables: CreateBillingProfileMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<CreateBillingProfileMutation, CreateBillingProfileMutationVariables>(
    client,
