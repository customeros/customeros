...
export type TenantUpdateBillingProfileMutation = {
  __typename?: 'Mutation';
...
>(
  ...
  options?: UseMutationOptions<
    TenantUpdateBillingProfileMutation,
    TError,
    TenantUpdateBillingProfileMutationVariables,
    TContext
  >,
  ...
  >({
    ...
    mutationFn: (variables?: TenantUpdateBillingProfileMutationVariables) =>
      fetcher<
        TenantUpdateBillingProfileMutation,
        TenantUpdateBillingProfileMutationVariables
      >(client, TenantUpdateBillingProfileDocument, variables, headers)(),
    ...options,
  });
};

useTenantUpdateBillingProfileMutation.getKey = () => [
  'TenantUpdateBillingProfile',
];

useTenantUpdateBillingProfileMutation.fetcher = (
  client: GraphQLClient,
  variables: TenantUpdateBillingProfileMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<
    TenantUpdateBillingProfileMutation,
