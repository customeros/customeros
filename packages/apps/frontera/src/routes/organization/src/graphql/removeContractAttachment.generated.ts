...
export type RemoveContractAttachmentMutation = {
  __typename?: 'Mutation';
...
>(
  ...
  options?: UseMutationOptions<
    RemoveContractAttachmentMutation,
    TError,
    RemoveContractAttachmentMutationVariables,
    TContext
  >,
  ...
  >({
    ...
    mutationFn: (variables?: RemoveContractAttachmentMutationVariables) =>
      fetcher<
        RemoveContractAttachmentMutation,
        RemoveContractAttachmentMutationVariables
      >(client, RemoveContractAttachmentDocument, variables, headers)(),
    ...options,
  });
};
...
useRemoveContractAttachmentMutation.fetcher = (
  client: GraphQLClient,
  variables: RemoveContractAttachmentMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<
    RemoveContractAttachmentMutation,
