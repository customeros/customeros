...
export const useRemindersQuery = <TData = RemindersQuery, TError = unknown>(
  ...
  options?: Omit<UseQueryOptions<RemindersQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<RemindersQuery, TError, TData>['queryKey'];
  },
  headers?: RequestInit['headers'],
) => {
  return useQuery<RemindersQuery, TError, TData>({
    queryKey: ['reminders', variables],
    queryFn: fetcher<RemindersQuery, RemindersQueryVariables>(
      client,
      RemindersDocument,
      variables,
      headers,
...
useRemindersQuery.getKey = (variables: RemindersQueryVariables) => [
  'reminders',
  variables,
];
...
>(
  ...
  variables: RemindersQueryVariables,
  options: Omit<
    UseInfiniteQueryOptions<RemindersQuery, TError, TData>,
    'queryKey'
  > & {
  ...
  return useInfiniteQuery<RemindersQuery, TError, TData>(
    (() => {
      ...
      return {
        ...
        queryFn: (metaData) =>
          fetcher<RemindersQuery, RemindersQueryVariables>(
            client,
            RemindersDocument,
...
useInfiniteRemindersQuery.getKey = (variables: RemindersQueryVariables) => [
  'reminders.infinite',
  variables,
];

useRemindersQuery.fetcher = (
  client: GraphQLClient,
  variables: RemindersQueryVariables,
  headers?: RequestInit['headers'],
) =>
