...
export const useUpdateContactMutation = <
    ...
    mutationFn: (variables?: UpdateContactMutationVariables) => fetcher<UpdateContactMutation, UpdateContactMutationVariables>(client, UpdateContactDocument, variables, headers)(),
    ...options
  }
    )};
...
useUpdateContactMutation.fetcher = (client: GraphQLClient, variables: UpdateContactMutationVariables, headers?: RequestInit['headers']) => fetcher<UpdateContactMutation, UpdateContactMutationVariables>(client, UpdateContactDocument, variables, headers);
