...
export type NextDryRunInvoiceForContractMutation = {
  __typename?: 'Mutation';
...
>(
  ...
  options?: UseMutationOptions<
    NextDryRunInvoiceForContractMutation,
    TError,
    NextDryRunInvoiceForContractMutationVariables,
    TContext
  >,
  ...
  >({
    ...
    mutationFn: (variables?: NextDryRunInvoiceForContractMutationVariables) =>
      fetcher<
        NextDryRunInvoiceForContractMutation,
        NextDryRunInvoiceForContractMutationVariables
      >(client, NextDryRunInvoiceForContractDocument, variables, headers)(),
    ...options,
  });
};

useNextDryRunInvoiceForContractMutation.getKey = () => [
  'NextDryRunInvoiceForContract',
];

useNextDryRunInvoiceForContractMutation.fetcher = (
  client: GraphQLClient,
  variables: NextDryRunInvoiceForContractMutationVariables,
  headers?: RequestInit['headers'],
) =>
  fetcher<
    NextDryRunInvoiceForContractMutation,
