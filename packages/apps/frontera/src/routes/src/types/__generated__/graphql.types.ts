 ...
 * **A `response` object.**
 */
export type Contact = MetadataInterface & Node & {
  __typename?: 'Contact';
...
export type TimelineEvent = Action | InteractionEvent | InteractionSession | Issue | LogEntry | MarkdownEvent | Meeting | Note | PageView;
