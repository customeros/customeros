...
export const NewMeetingRecording = observer(() => {
  ...
  const usecase = useMemo(() => new NewMeetingRecordingUsecase(id!), [id]);
    ...
    <div>
      ...
      {usecase.notetaker && (
        <div className='flex flex-col gap-1'>
          ...
          <div className='flex items-center justify-between gap-1 px-2 py-1 border border-grayModern-200 rounded-md max-w-[320px] min-h-8 bg-white'>
            <p
              className={cn(
                'text-sm truncate',
