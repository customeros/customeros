...
export const EvaluateCompanyIcpFit = observer(() => {
  ...
  return (
    <article className='flex flex-col gap-4'>
      <h1 className='text-sm font-medium'>Evaluate company ICP fit</h1>
      <div>
        ...
        <p className='text-sm'>
          ...
          qualifiers like industry types or describe key qualifications, such as
          specific regions, company size, or founding date.
        </p>
        ...
        <Textarea
          ...
          className='mt-3 px-2 py-1 text-sm bg-transparent resize-none min-h-[72px] overflow-hidden'
          onChange={(e) => {
      ...
      <div>
        <h2 className='text-sm font-medium mb-1'>Disqualification criteria</h2>
        <p className='text-sm'>
