...
type PageViewFunc func(context.Context, *gen.PageViewMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f PageViewFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	mv, ok := m.(*gen.PageViewMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.PageViewMutation", m)
	}
	return f(ctx, mv)
}
...
type VisitorFunc func(context.Context, *gen.VisitorMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f VisitorFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	mv, ok := m.(*gen.VisitorMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.VisitorMutation", m)
	}
	return f(ctx, mv)
}
