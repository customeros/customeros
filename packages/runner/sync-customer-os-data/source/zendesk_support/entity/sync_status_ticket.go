...
type SyncStatusTicket struct {
	Id                   int64     `gorm:"column:id;primaryKey"`
	AirbyteAbId          string    `gorm:"column:_airbyte_ab_id;primaryKey"`
	AirbyteTicketsHashid string    `gorm:"column:_airbyte_tickets_hashid;primaryKey"`
...
func (SyncStatusTicket) TableName() string {
	return "openline_sync_status_tickets"
}
