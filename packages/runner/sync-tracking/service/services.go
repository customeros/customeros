...
func InitServices(cfg *config.Config, driver *neo4j.DriverWithContext, postgresDB *commonConfig.PostgresDB, grpcClient *grpc_client.Clients, logger logger.Logger) *Services {
	...
	}, postgresDB, driver, cfg.Neo4j.Database, grpcClient, logger)
