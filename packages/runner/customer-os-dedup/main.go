...
import (
	...
	localCron "github.com/customeros/customeros/packages/runner/customer-os-dedup/cron"
...
func main() {
	...
	cntnr := &container.Container{
		Cfg:                     cfg,
		Log:                     appLogger,
		Repositories:            repository.InitRepositories(&neo4jDriver, cfg.CommonConfig.Infrastructure.Neo4jConfig.Database, postgresDb),
