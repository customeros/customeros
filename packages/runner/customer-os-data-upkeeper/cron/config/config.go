...
type Config struct {
	...
	CronScheduleIcpCheck                   string `env:"CRON_SCHEDULE_ICP_CHECK" envDefault:"0 */2 * * * *"`
	...
	CronScheduleGlobalOrgScrape                string `env:"CRON_SCHEDULE_GLOBAL_ORG_SCRAPE" envDefault:"20 */2 * * * *"`
	...
	CronScheduleUpkeepInvoices  string `env:"CRON_SCHEDULE_UPKEEP_INVOICES" envDefault:"0 20 */8 * * *"`
	...
	// Email
	CronScheduleValidateEmails                 string `env:"CRON_SCHEDULE_VALIDATE_EMAILS" envDefault:"0,30 * * * * *"`
	CronScheduleValidateEmailsFromBulkRequests string `env:"CRON_SCHEDULE_VALIDATE_EMAILS_BULK_REQUEST" envDefault:"*/30 * * * * *"`
	...
	CronScheduleIngestEmailsFromProviders      string `env:"CRON_SCHEDULE_INGEST_EMAILS_FROM_PROVIDERS" envDefault:"*/10 * * * * *"`
