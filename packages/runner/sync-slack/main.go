...
import (
	...
	"github.com/openline-ai/openline-customer-os/packages/runner/sync-slack/constants"
	"github.com/openline-ai/openline-customer-os/packages/runner/sync-slack/container"
	localCron "github.com/openline-ai/openline-customer-os/packages/runner/sync-slack/cron"
...
func main() {
	...
	// raw data db
	rawDataStoreDb := config.InitPoolManager(cfg)
